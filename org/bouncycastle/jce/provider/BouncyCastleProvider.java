...
{
    private static String field_57418_c = "BouncyCastle Security Provider v1.47";
    public static String field_57419_a = "BC";
    public static final ProviderConfiguration field_57417_b = new BouncyCastleProviderConfiguration();
    private static final Map field_57415_d = new HashMap();
    private static final String field_57416_e[] =
    {
    ...
    private static final String field_57413_f[] =
    {
        "X509"
    };
    private static final String field_57414_g[] =
    {
        "DSA", "DH", "EC", "RSA", "GOST", "ECGOST", "ElGamal"
    };
    private static final String field_57420_h[] =
    {
    ...
    {
        super(field_57419_a, 1.47D, field_57418_c);
        AccessController.doPrivileged(new BouncyCastleProviderAction(this));
    }

    private void func_57410_a()
    {
        func_57411_a("org.bouncycastle.jcajce.provider.digest.", field_57420_h);
        func_57411_a("org.bouncycastle.jcajce.provider.symmetric.", field_57416_e);
        func_57411_a("org.bouncycastle.jcajce.provider.asymmetric.", field_57413_f);
        func_57411_a("org.bouncycastle.jcajce.provider.asymmetric.", field_57414_g);
        ...
        put((new StringBuilder()).append("AlgorithmParameters.").append(PKCSObjectIdentifiers.field_57683_z).toString(), "org.bouncycastle.jce.provider.JDKAlgorithmParameters$PBKDF2");
        ...
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.field_56938_l.func_57266_b()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.field_56939_m.func_57266_b()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.field_56936_n.func_57266_b()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.field_56937_o.func_57266_b()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.field_56945_p.func_57266_b()).toString(), "PKCS12PBE");
        put((new StringBuilder()).append("Alg.Alias.AlgorithmParameters.").append(BCObjectIdentifiers.field_56944_q.func_57266_b()).toString(), "PKCS12PBE");
        ...
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.field_56938_l.func_57266_b()).toString(), "PBEWITHSHAAND128BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.field_56939_m.func_57266_b()).toString(), "PBEWITHSHAAND192BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.field_56936_n.func_57266_b()).toString(), "PBEWITHSHAAND256BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.field_56937_o.func_57266_b()).toString(), "PBEWITHSHA256AND128BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.field_56945_p.func_57266_b()).toString(), "PBEWITHSHA256AND192BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(BCObjectIdentifiers.field_56944_q.func_57266_b()).toString(), "PBEWITHSHA256AND256BITAES-CBC-BC");
        ...
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.field_57679_s).toString(), "PBEWITHMD2ANDDES");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.field_57678_t).toString(), "PBEWITHMD2ANDRC2");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.field_57677_u).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.field_57676_v).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.field_57675_w).toString(), "PBEWITHSHA1ANDDES");
        put((new StringBuilder()).append("Alg.Alias.Cipher.").append(PKCSObjectIdentifiers.field_57685_x).toString(), "PBEWITHSHA1ANDRC2");
        ...
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57679_s).toString(), "PBEWITHMD2ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57678_t).toString(), "PBEWITHMD2ANDRC2");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57677_u).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57676_v).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57675_w).toString(), "PBEWITHSHA1ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57685_x).toString(), "PBEWITHSHA1ANDRC2");
        ...
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57678_t).toString(), "PBEWITHMD2ANDRC2");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57677_u).toString(), "PBEWITHMD5ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57676_v).toString(), "PBEWITHMD5ANDRC2");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57675_w).toString(), "PBEWITHSHA1ANDDES");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(PKCSObjectIdentifiers.field_57685_x).toString(), "PBEWITHSHA1ANDRC2");
        ...
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.field_56938_l.func_57266_b()).toString(), "PBEWITHSHAAND128BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.field_56939_m.func_57266_b()).toString(), "PBEWITHSHAAND192BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.field_56936_n.func_57266_b()).toString(), "PBEWITHSHAAND256BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.field_56937_o.func_57266_b()).toString(), "PBEWITHSHA256AND128BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.field_56945_p.func_57266_b()).toString(), "PBEWITHSHA256AND192BITAES-CBC-BC");
        put((new StringBuilder()).append("Alg.Alias.SecretKeyFactory.").append(BCObjectIdentifiers.field_56944_q.func_57266_b()).toString(), "PBEWITHSHA256AND256BITAES-CBC-BC");
        func_57412_b();
    ...
    private void func_57411_a(String par1Str, String par2ArrayOfStr[])
    {
        for (int i = 0; i != par2ArrayOfStr.length; i++)
        {
            ...
            try
            {
                ((AlgorithmProvider)class1.newInstance()).func_57514_a(this);
                continue;
            }
    ...
    static void func_57409_a(BouncyCastleProvider par0BouncyCastleProvider)
    {
        par0BouncyCastleProvider.func_57410_a();
    }
}
