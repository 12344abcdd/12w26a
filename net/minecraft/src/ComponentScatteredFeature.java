...
{
    protected final int field_56607_a;
    protected final int field_56605_b;
    protected final int field_56606_c;
    protected int field_56604_d;
    ...
    protected boolean func_56603_a(World par1World, StructureBoundingBox par2StructureBoundingBox, int par3)
    {
        if (field_56604_d >= 0)
        {
            return true;
        ...
        {
            field_56604_d = i / j;
            boundingBox.offset(0, (field_56604_d - boundingBox.minY) + par3, 0);
            return true;
        }
    }
}
