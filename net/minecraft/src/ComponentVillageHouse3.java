...
public class ComponentVillageHouse3 extends ComponentVillage
{
    ...
    public static ComponentVillageHouse3 func_56626_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
