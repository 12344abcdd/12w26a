...
{
    public int field_55171_a;
    public WorldType terrainType;
    public boolean field_56536_c;
    public EnumGameType field_56535_d;
    ...
    public Packet1Login(int par1, WorldType par2WorldType, EnumGameType par3EnumGameType, boolean par4, int par5, int par6, int par7, int par8)
    {
        ...
        field_56535_d = par3EnumGameType;
    ...
    {
        field_55171_a = par1DataInputStream.readInt();
        ...
        field_56536_c = (i & 8) == 8;
        i &= -9;
        field_56535_d = EnumGameType.func_57536_a(i);
        field_48170_e = par1DataInputStream.readByte();
    ...
    {
        par1DataOutputStream.writeInt(field_55171_a);
        writeString(terrainType != null ? terrainType.func_48628_a() : "", par1DataOutputStream);
        int i = field_56535_d.func_57538_a();
        ...
        par1DataOutputStream.writeByte(field_48170_e);
