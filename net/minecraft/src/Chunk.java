...
public class Chunk
{
    ...
    public boolean setBlockIDWithMetadata(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        {
            Block.blocksList[k].func_56770_g(worldObj, i1, par2, j1, l);
        }
        ...
        if (k != 0)
        {
            ...
            {
                Block.blocksList[k].func_56762_a(worldObj, i1, par2, j1, k, l);
            }
        ...
        if (par4 != 0)
        {
            ...
            if (Block.blocksList[par4] instanceof BlockContainer)
            {
                ...
                if (tileentity == null)
                {
                    tileentity = ((BlockContainer)Block.blocksList[par4]).func_56783_a(worldObj);
    ...
    public TileEntity getChunkBlockTileEntity(int par1, int par2, int par3)
    {
        ...
        if (tileentity == null)
        {
            ...
            if (tileentity == null)
            {
                tileentity = ((BlockContainer)Block.blocksList[i]).func_56783_a(worldObj);
    ...
    {
        ChunkPosition chunkposition = new ChunkPosition(par1, par2, par3);
        par4TileEntity.func_56202_a(worldObj);
