...
{
    private List field_55309_a;
    private List field_55308_b;

    public EntityAITasks()
    {
        field_55309_a = new ArrayList();
        field_55308_b = new ArrayList();
    }

    public void addTask(int par1, EntityAIBase par2EntityAIBase)
    {
        field_55309_a.add(new EntityAITaskEntry(this, par1, par2EntityAIBase));
    }

    public void onUpdateTasks()
    {
        ArrayList arraylist = new ArrayList();
        Iterator iterator = field_55309_a.iterator();
        ...
        do
        {
            ...
            boolean flag1 = field_55308_b.contains(entityaitaskentry);
        ...
        for (Iterator iterator2 = field_55308_b.iterator(); iterator2.hasNext(); entityaitaskentry2.action.updateTask())
        {
    ...
    private boolean func_46116_a(EntityAITaskEntry par1EntityAITaskEntry)
    {
        label0:
        {
            ...
            do
            {
                ...
                while (!field_55308_b.contains(entityaitaskentry) || areTasksCompatible(par1EntityAITaskEntry, entityaitaskentry));

                return false;
            }
            while (!field_55308_b.contains(entityaitaskentry) || entityaitaskentry.action.isContinuous());
