...
public class ItemFood extends Item
{
    ...
    public ItemFood(int par1, int par2, float par3, boolean par4)
    {
        ...
        func_56813_a(CreativeTabs.field_57059_h);
    }
    ...
    public ItemStack onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        func_56832_d(par1ItemStack, par2World, par3EntityPlayer);
        return par1ItemStack;
    }

    protected void func_56832_d(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
