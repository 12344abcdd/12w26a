...
public class GuiGameOver extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            case 1:
                mc.field_56455_h.respawnPlayer();
                mc.displayGuiScreen(null);
                break;

            case 2:
                mc.field_56452_f.sendQuittingDisconnectingPacket();
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        boolean flag = mc.field_56452_f.getWorldInfo().isHardcoreModeEnabled();
        ...
        drawCenteredString(fontRenderer, (new StringBuilder()).append(StatCollector.translateToLocal("deathScreen.score")).append(": \247e").append(mc.field_56455_h.getScore()).toString(), width / 2, 100, 0xffffff);
