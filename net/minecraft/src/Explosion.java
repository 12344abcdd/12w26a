...
public class Explosion
{
    ...
    public List field_58127_g;
    private Map field_57170_k;
    ...
    public Explosion(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9)
    {
        ...
        field_58127_g = new ArrayList();
        field_57170_k = new HashMap();
        worldObj = par1World;
        exploder = par2Entity;
        explosionSize = par9;
        explosionX = par3;
    ...
    public void doExplosionA()
    {
        ...
        for (int i = 0; i < field_57171_h; i++)
        {
            for (int k = 0; k < field_57171_h; k++)
            {
                label0:

                for (int i1 = 0; i1 < field_57171_h; i1++)
                {
                    if (i != 0 && i != field_57171_h - 1 && k != 0 && k != field_57171_h - 1 && i1 != 0 && i1 != field_57171_h - 1)
                    {
                        continue;
                    }

                    double d = ((float)i / ((float)field_57171_h - 1.0F)) * 2.0F - 1.0F;
                    double d1 = ((float)k / ((float)field_57171_h - 1.0F)) * 2.0F - 1.0F;
                    double d2 = ((float)i1 / ((float)field_57171_h - 1.0F)) * 2.0F - 1.0F;
        ...
        List list = worldObj.getEntitiesWithinAABBExcludingEntity(exploder, AxisAlignedBB.func_58144_a().func_58153_a(j, j1, l1, l, k1, i2));
        Vec3 vec3 = Vec3.func_58128_a().func_58134_a(explosionX, explosionY, explosionZ);
        ...
        for (int j2 = 0; j2 < list.size(); j2++)
        {
            ...
            {
                field_57170_k.put((EntityPlayer)entity, Vec3.func_58128_a().func_58134_a(d6 * d13, d8 * d13, d10 * d13));
            }
        }
    ...
    public void doExplosionB(boolean par1)
    {
        ...
        Iterator iterator = field_58127_g.iterator();
        ...
        if (isFlaming)
        {
            Iterator iterator1 = field_58127_g.iterator();
    ...
    public Map func_57169_b()
    {
        return field_57170_k;
    }
}
