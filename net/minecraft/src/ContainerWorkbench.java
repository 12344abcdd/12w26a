...
public class ContainerWorkbench extends Container
{
    ...
    public ContainerWorkbench(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
        ...
        posY = par4;
        posZ = par5;
        func_55197_a(new SlotCrafting(par1InventoryPlayer.player, craftMatrix, craftResult, 0, 124, 35));

        for (int i = 0; i < 3; i++)
        {
            for (int l = 0; l < 3; l++)
            {
                func_55197_a(new Slot(craftMatrix, l + i * 3, 30 + l * 18, 17 + i * 18));
            }
        }
        ...
        for (int j = 0; j < 3; j++)
        {
            ...
            {
                func_55197_a(new Slot(par1InventoryPlayer, i1 + j * 9 + 9, 8 + i1 * 18, 84 + j * 18));
            }
        }

        for (int k = 0; k < 9; k++)
        {
            func_55197_a(new Slot(par1InventoryPlayer, k, 8 + k * 18, 142));
        }
