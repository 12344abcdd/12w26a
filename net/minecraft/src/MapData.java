...
public class MapData extends WorldSavedData
{
    ...
    public byte[] func_56989_a(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        MapInfo mapinfo = (MapInfo)field_28172_j.get(par3EntityPlayer);
        ...
        {
            return mapinfo.func_57575_a(par1ItemStack);
        }
    }
