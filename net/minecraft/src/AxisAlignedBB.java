...
{
    private static final ThreadLocal field_57512_g = new AABBLocalPool();
    public double minX;
    public double minY;
    public double minZ;
    public double maxX;
    ...
    public static AABBPool func_58144_a()
    {
        return (AABBPool)field_57512_g.get();
    }
    ...
    public AxisAlignedBB addCoord(double par1, double par3, double par5)
    {
        ...
        return func_58144_a().func_58153_a(d, d1, d2, d3, d4, d5);
    }
    ...
    {
        return func_58144_a().func_58153_a(minX + par1, minY + par3, minZ + par5, maxX + par1, maxY + par3, maxZ + par5);
    }
    ...
    {
        return func_58144_a().func_58153_a(minX, minY, minZ, maxX, maxY, maxZ);
    }
