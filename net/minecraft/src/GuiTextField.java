...
public class GuiTextField extends Gui
{
    ...
    {
        return func_55091_a(par1, func_50035_h(), true);
    }

    public int func_55091_a(int par1, int par2, boolean par3)
    {
        int i = par2;
        boolean flag = par1 < 0;
        int j = Math.abs(par1);
    ...
    public void func_56465_g(int par1)
    {
        field_50047_q = par1;
    }
    ...
    public boolean func_56464_m()
    {
        return field_56467_s;
    }

    public void func_56466_d(boolean par1)
    {
        field_56467_s = par1;
    }
}
