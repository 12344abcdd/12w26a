...
public class WorldClient extends World
{
    ...
    private final Minecraft field_56845_M = Minecraft.func_55068_z();
    ...
    public void func_56843_d(int par1, int par2, int par3)
    {
        byte byte0 = 16;
    ...
    {
        par1CrashReport = super.func_55266_a(par1CrashReport);
        par1CrashReport.func_55366_a("Forced Entities", new CallableMPL1(this));
        par1CrashReport.func_55366_a("Retry Entities", new CallableMPL2(this));
        return par1CrashReport;
    }

    public void func_56841_a(double par1, double par3, double par5, String par7Str, float par8, float par9)
    {
        float f = 16F;
        ...
        if (field_56845_M.renderViewEntity.getDistanceSq(par1, par3, par5) < (double)(f * f))
        {
            field_56845_M.sndManager.playSound(par7Str, (float)par1, (float)par3, (float)par5, par8, par9);
        }
    }

    static Set func_55273_a(WorldClient par0WorldClient)
    {
        return par0WorldClient.entityList;
    }

    static Set func_55272_b(WorldClient par0WorldClient)
    {
