...
{
    private MinecraftServer field_56645_a;
    private WorldServer field_56644_b;

    public WorldManager(MinecraftServer par1MinecraftServer, WorldServer par2WorldServer)
    {
        field_56645_a = par1MinecraftServer;
        field_56644_b = par2WorldServer;
    }
    ...
    {
        field_56644_b.func_56859_K().func_57595_a(par1Entity);
    }
    ...
    {
        field_56644_b.func_56859_K().func_57594_b(par1Entity);
    }
    ...
    {
        field_56645_a.func_56339_Z().func_57095_a(par2, par4, par6, par8 <= 1.0F ? 16D : 16F * par8, field_56644_b.worldProvider.worldType, new Packet62LevelSound(par1Str, par2, par4, par6, par8, par9));
    }
    ...
    {
        field_56644_b.func_56858_L().func_57608_a(par1, par2, par3);
    }
    ...
    {
        field_56645_a.func_56339_Z().func_57111_a(par1EntityPlayer, par3, par4, par5, 64D, field_56644_b.worldProvider.worldType, new Packet61DoorChange(par2, par3, par4, par5, par6));
    }

    public void func_56643_a(int par1, int par2, int par3, int par4, int par5)
    {
        Iterator iterator = field_56645_a.func_56339_Z().field_57133_b.iterator();
        ...
        do
        {
            ...
            if (entityplayermp != null && entityplayermp.worldObj == field_56644_b && entityplayermp.entityId != par1)
            {
                ...
                {
                    entityplayermp.field_56268_a.func_56717_b(new Packet55BlockDestroy(par1, par2, par3, par4, par5));
                }
            }
        }
        while (true);
