...
public class GuiSelectWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        localizedGameModeText[EnumGameType.SURVIVAL.func_57538_a()] = stringtranslate.translateKey("gameMode.survival");
        localizedGameModeText[EnumGameType.CREATIVE.func_57538_a()] = stringtranslate.translateKey("gameMode.creative");
        localizedGameModeText[EnumGameType.ADVENTURE.func_57538_a()] = stringtranslate.translateKey("gameMode.adventure");
        loadSaves();
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.id == 2)
        {
            ...
            {
                deleting = true;
                GuiYesNo guiyesno = func_55139_a(this, s, selectedWorld);
    ...
    public static GuiYesNo func_55139_a(GuiScreen par0GuiScreen, String par1Str, int par2)
    {
        StringTranslate stringtranslate = StringTranslate.getInstance();
