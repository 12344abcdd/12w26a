...
{
    private static final Map field_56920_a = new HashMap();
    private static final List field_56919_b = new ArrayList();
    ...
    public static synchronized int generateDisplayLists(int par0)
    {
        ...
        field_56920_a.put(Integer.valueOf(i), Integer.valueOf(par0));
        return i;
    }
    ...
    public static synchronized void generateTextureNames(IntBuffer par0IntBuffer)
    {
        ...
        {
            field_56919_b.add(Integer.valueOf(par0IntBuffer.get(i)));
        }
    }

    public static synchronized void deleteDisplayLists(int par0)
    {
        GL11.glDeleteLists(par0, ((Integer)field_56920_a.remove(Integer.valueOf(par0))).intValue());
    }
    ...
    public static synchronized void deleteTexturesAndDisplayLists()
    {
        ...
        for (Iterator iterator = field_56920_a.entrySet().iterator(); iterator.hasNext(); GL11.glDeleteLists(((Integer)entry.getKey()).intValue(), ((Integer)entry.getValue()).intValue()))
        {
        ...
        for (Iterator iterator1 = field_56919_b.iterator(); iterator1.hasNext(); GL11.glDeleteTextures(i))
        {
