...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float par1)
    {
        ...
        float f3 = mc.field_56452_f.getLightBrightness(MathHelper.floor_double(((EntityPlayer)(entityclientplayermp)).posX), MathHelper.floor_double(((EntityPlayer)(entityclientplayermp)).posY), MathHelper.floor_double(((EntityPlayer)(entityclientplayermp)).posZ));
        f3 = 1.0F;
        int i = mc.field_56452_f.getLightBrightnessForSkyBlocks(MathHelper.floor_double(((EntityPlayer)(entityclientplayermp)).posX), MathHelper.floor_double(((EntityPlayer)(entityclientplayermp)).posY), MathHelper.floor_double(((EntityPlayer)(entityclientplayermp)).posZ), 0);
        int k = i % 0x10000;
        int l = i / 0x10000;
        ...
        if (itemstack != null && itemstack.itemID == Item.map.shiftedIndex)
        {
            ...
            GL11.glEnable(GL12.GL_RESCALE_NORMAL);
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.getTextureForDownloadableImage(mc.field_56455_h.skinUrl, mc.field_56455_h.getTexture()));
            ...
            for (f14 = 0; f14 < 2; f14++)
            {
                ...
                Render render = RenderManager.instance.getEntityRenderObject(mc.field_56455_h);
            ...
            tessellator.draw();
            MapData mapdata = Item.map.getMapData(itemstack, mc.field_56452_f);
            mapItemRenderer.renderMap(mc.field_56455_h, mc.renderEngine, mapdata);
            GL11.glPopMatrix();
        }
        ...
        else
        {
            ...
            Render render1 = RenderManager.instance.getEntityRenderObject(mc.field_56455_h);
    ...
    public void renderOverlays(float par1)
    {
        ...
        if (mc.field_56455_h.isEntityInsideOpaqueBlock())
        {
            int j = MathHelper.floor_double(mc.field_56455_h.posX);
            int l = MathHelper.floor_double(mc.field_56455_h.posY);
            int i1 = MathHelper.floor_double(mc.field_56455_h.posZ);
            int j1 = mc.renderEngine.getTexture("/terrain.png");
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, j1);
            int k1 = mc.field_56452_f.getBlockId(j, l, i1);

            if (mc.field_56452_f.isBlockNormalCube(j, l, i1))
            {
            ...
            else
            {
                ...
                {
                    float f = ((float)((l1 >> 0) % 2) - 0.5F) * mc.field_56455_h.width * 0.9F;
                    float f1 = ((float)((l1 >> 1) % 2) - 0.5F) * mc.field_56455_h.height * 0.2F;
                    float f2 = ((float)((l1 >> 2) % 2) - 0.5F) * mc.field_56455_h.width * 0.9F;
                    int i2 = MathHelper.floor_float((float)j + f);
                    int j2 = MathHelper.floor_float((float)l + f1);
                    int k2 = MathHelper.floor_float((float)i1 + f2);

                    if (mc.field_56452_f.isBlockNormalCube(i2, j2, k2))
                    {
                        k1 = mc.field_56452_f.getBlockId(i2, j2, k2);
                    }
                }
            }
    ...
    {
        Tessellator tessellator = Tessellator.instance;
        float f = mc.field_56455_h.getBrightness(par1);
        f = 0.1F;
    ...
    private void renderWarpedTextureOverlay(float par1)
    {
        ...
        float f5 = 1.0F;
        float f6 = -0.5F;
        float f7 = -mc.field_56455_h.rotationYaw / 64F;
        float f8 = mc.field_56455_h.rotationPitch / 64F;
        tessellator.startDrawingQuads();
