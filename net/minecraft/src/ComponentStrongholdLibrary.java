...
{
    private static final WeightedRandomChestContent field_55076_b[];
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        func_56600_a(par1World, par3StructureBoundingBox, par2Random, 3, 3, 5, field_55076_b, 1 + par2Random.nextInt(4));

        if (isLargeRoom)
        {
            placeBlockAtCurrentPosition(par1World, 0, 0, 12, 9, 1, par3StructureBoundingBox);
            func_56600_a(par1World, par3StructureBoundingBox, par2Random, 12, 8, 1, field_55076_b, 1 + par2Random.nextInt(4));
        }
    ...
    static
    {
        field_55076_b = (new WeightedRandomChestContent[]
                {
