...
{
    private SimpleDateFormat field_57601_a;

    ConsoleLogFormatter()
    {
        field_57601_a = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    }

    public String format(LogRecord par1LogRecord)
    {
        StringBuilder stringbuilder = new StringBuilder();
        stringbuilder.append(field_57601_a.format(Long.valueOf(par1LogRecord.getMillis())));
