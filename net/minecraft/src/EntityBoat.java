...
{
    private boolean field_56184_a;
    private double field_56183_b;
    ...
    public EntityBoat(World par1World)
    {
        super(par1World);
        field_56184_a = true;
        field_56183_b = 0.070000000000000007D;
    ...
    public void onUpdate()
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            AxisAlignedBB axisalignedbb = AxisAlignedBB.func_58144_a().func_58153_a(boundingBox.minX, d2, boundingBox.minZ, boundingBox.maxX, d8, boundingBox.maxZ);
        ...
        if (worldObj.isRemote && field_56184_a)
        {
        ...
        if (riddenByEntity != null)
        {
            motionX += riddenByEntity.motionX * field_56183_b;
            motionZ += riddenByEntity.motionZ * field_56183_b;
        }
        ...
        if (d7 > d1 && field_56183_b < 0.34999999999999998D)
        {
            field_56183_b += (0.34999999999999998D - field_56183_b) / 35D;

            if (field_56183_b > 0.34999999999999998D)
            {
                field_56183_b = 0.34999999999999998D;
            }
        }
        else
        {
            field_56183_b -= (field_56183_b - 0.070000000000000007D) / 35D;

            if (field_56183_b < 0.070000000000000007D)
            {
                field_56183_b = 0.070000000000000007D;
            }
        }
    ...
    public void func_56182_a(boolean par1)
    {
        field_56184_a = par1;
    }
}
