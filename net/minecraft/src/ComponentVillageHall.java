...
public class ComponentVillageHall extends ComponentVillage
{
    ...
    public static ComponentVillageHall func_56621_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        fillWithBlocks(par1World, par3StructureBoundingBox, 5, 0, 1, 7, 0, 3, Block.field_55203_aj.blockID, Block.field_55203_aj.blockID, false);
        placeBlockAtCurrentPosition(par1World, Block.field_55203_aj.blockID, 0, 6, 1, 1, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_55203_aj.blockID, 0, 6, 1, 2, par3StructureBoundingBox);
