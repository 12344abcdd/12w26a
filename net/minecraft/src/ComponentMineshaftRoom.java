...
public class ComponentMineshaftRoom extends StructureComponent
{
    ...
    public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random)
    {
        ...
        for (int j = 0; j < boundingBox.getXSize(); j += 4)
        {
            ...
            if (structurecomponent != null)
            {
                ...
                field_55078_a.add(new StructureBoundingBox(structureboundingbox.minX, structureboundingbox.minY, boundingBox.minZ, structureboundingbox.maxX, structureboundingbox.maxY, boundingBox.minZ + 1));
            }
        }
        ...
        for (int k = 0; k < boundingBox.getXSize(); k += 4)
        {
            ...
            if (structurecomponent1 != null)
            {
                ...
                field_55078_a.add(new StructureBoundingBox(structureboundingbox1.minX, structureboundingbox1.minY, boundingBox.maxZ - 1, structureboundingbox1.maxX, structureboundingbox1.maxY, boundingBox.maxZ));
            }
        }
        ...
        for (int l = 0; l < boundingBox.getZSize(); l += 4)
        {
            ...
            if (structurecomponent2 != null)
            {
                ...
                field_55078_a.add(new StructureBoundingBox(boundingBox.minX, structureboundingbox2.minY, structureboundingbox2.minZ, boundingBox.minX + 1, structureboundingbox2.maxY, structureboundingbox2.maxZ));
            }
        }
        ...
        for (int i1 = 0; i1 < boundingBox.getZSize(); i1 += 4)
        {
            ...
            if (structurecomponent3 != null)
            {
                ...
                field_55078_a.add(new StructureBoundingBox(boundingBox.maxX - 1, structureboundingbox3.minY, structureboundingbox3.minZ, boundingBox.maxX, structureboundingbox3.maxY, structureboundingbox3.maxZ));
            }
        }
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        for (Iterator iterator = field_55078_a.iterator(); iterator.hasNext(); fillWithBlocks(par1World, par3StructureBoundingBox, structureboundingbox.minX, structureboundingbox.maxY - 2, structureboundingbox.minZ, structureboundingbox.maxX, structureboundingbox.maxY, structureboundingbox.maxZ, 0, 0, false))
        {
