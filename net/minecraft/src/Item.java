...
public class Item
{
    private CreativeTabs field_56818_a;
    ...
    public static Item field_56819_n;
    ...
    public static Item field_55215_bF;
    public static Item field_55216_bG = (new ItemEditableBook(131)).setIconCoord(12, 11).setItemName("writtenBook");
    ...
    public boolean func_56812_a(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int i, int j, int k, int l, float f, float f1, float f2)
    {
        return false;
    }
    ...
    public boolean func_58078_a(ItemStack par1ItemStack, World par2World, int par3, int i, int j, int k, EntityLiving entityliving)
    {
        return false;
    }
    ...
    public boolean func_56815_a(ItemStack par1ItemStack, EntityLiving par2EntityLiving)
    {
        return false;
    }
    ...
    public String func_56817_j(ItemStack par1ItemStack)
    {
    ...
    protected MovingObjectPosition getMovingObjectPositionFromPlayer(World par1World, EntityPlayer par2EntityPlayer, boolean par3)
    {
        ...
        Vec3 vec3 = Vec3.func_58128_a().func_58134_a(d, d1, d2);
    ...
    public CreativeTabs func_56811_f()
    {
        return field_56818_a;
    }

    public Item func_56813_a(CreativeTabs par1CreativeTabs)
    {
        field_56818_a = par1CreativeTabs;
        return this;
    }
    ...
    static
    {
        ...
        arrow = (new Item(6)).setIconCoord(5, 2).setItemName("arrow").func_56813_a(CreativeTabs.field_57057_j);
        field_56819_n = (new Item(8)).setIconCoord(7, 3).setItemName("diamond").func_56813_a(CreativeTabs.field_57055_l);
        ingotIron = (new Item(9)).setIconCoord(7, 1).setItemName("ingotIron").func_56813_a(CreativeTabs.field_57055_l);
        ingotGold = (new Item(10)).setIconCoord(7, 2).setItemName("ingotGold").func_56813_a(CreativeTabs.field_57055_l);
        ...
        stick = (new Item(24)).setIconCoord(5, 3).setFull3D().setItemName("stick").func_56813_a(CreativeTabs.field_57055_l);
        bowlEmpty = (new Item(25)).setIconCoord(7, 4).setItemName("bowl").func_56813_a(CreativeTabs.field_57055_l);
        ...
        silk = (new ItemReed(31, Block.field_56775_bU)).setIconCoord(8, 0).setItemName("string").func_56813_a(CreativeTabs.field_57055_l);
        feather = (new Item(32)).setIconCoord(8, 1).setItemName("feather").func_56813_a(CreativeTabs.field_57055_l);
        gunpowder = (new Item(33)).setIconCoord(8, 2).setItemName("sulphur").setPotionEffect(PotionHelper.gunpowderEffect).func_56813_a(CreativeTabs.field_57055_l);
        ...
        wheat = (new Item(40)).setIconCoord(9, 1).setItemName("wheat").func_56813_a(CreativeTabs.field_57055_l);
        ...
        flint = (new Item(62)).setIconCoord(6, 0).setItemName("flint").func_56813_a(CreativeTabs.field_57055_l);
        ...
        leather = (new Item(78)).setIconCoord(7, 6).setItemName("leather").func_56813_a(CreativeTabs.field_57055_l);
        bucketMilk = (new ItemBucketMilk(79)).setIconCoord(13, 4).setItemName("milk").setContainerItem(bucketEmpty);
        brick = (new Item(80)).setIconCoord(6, 1).setItemName("brick").func_56813_a(CreativeTabs.field_57055_l);
        clay = (new Item(81)).setIconCoord(9, 3).setItemName("clay").func_56813_a(CreativeTabs.field_57055_l);
        reed = (new ItemReed(82, Block.reed)).setIconCoord(11, 1).setItemName("reeds").func_56813_a(CreativeTabs.field_57055_l);
        paper = (new Item(83)).setIconCoord(10, 3).setItemName("paper").func_56813_a(CreativeTabs.field_57046_f);
        book = (new Item(84)).setIconCoord(11, 3).setItemName("book").func_56813_a(CreativeTabs.field_57046_f);
        slimeBall = (new Item(85)).setIconCoord(14, 1).setItemName("slimeball").func_56813_a(CreativeTabs.field_57046_f);
        compass = (new Item(89)).setIconCoord(6, 3).setItemName("compass").func_56813_a(CreativeTabs.field_57060_i);
        pocketSundial = (new Item(91)).setIconCoord(6, 4).setItemName("clock").func_56813_a(CreativeTabs.field_57060_i);
        lightStoneDust = (new Item(92)).setIconCoord(9, 4).setItemName("yellowDust").setPotionEffect(PotionHelper.glowstoneEffect).func_56813_a(CreativeTabs.field_57055_l);
        bone = (new Item(96)).setIconCoord(12, 1).setItemName("bone").setFull3D().func_56813_a(CreativeTabs.field_57046_f);
        sugar = (new Item(97)).setIconCoord(13, 0).setItemName("sugar").setPotionEffect(PotionHelper.sugarEffect).func_56813_a(CreativeTabs.field_57055_l);
        cake = (new ItemReed(98, Block.cake)).setMaxStackSize(1).setIconCoord(13, 1).setItemName("cake").func_56813_a(CreativeTabs.field_57059_h);
        redstoneRepeater = (new ItemReed(100, Block.redstoneRepeaterIdle)).setIconCoord(6, 5).setItemName("diode").func_56813_a(CreativeTabs.field_57048_d);
        ...
        blazeRod = (new Item(113)).setIconCoord(12, 6).setItemName("blazeRod").func_56813_a(CreativeTabs.field_57055_l);
        ghastTear = (new Item(114)).setIconCoord(11, 7).setItemName("ghastTear").setPotionEffect(PotionHelper.ghastTearEffect).func_56813_a(CreativeTabs.field_57058_k);
        goldNugget = (new Item(115)).setIconCoord(12, 7).setItemName("goldNugget").func_56813_a(CreativeTabs.field_57055_l);
        ...
        fermentedSpiderEye = (new Item(120)).setIconCoord(10, 8).setItemName("fermentedSpiderEye").setPotionEffect(PotionHelper.fermentedSpiderEyeEffect).func_56813_a(CreativeTabs.field_57058_k);
        blazePowder = (new Item(121)).setIconCoord(13, 9).setItemName("blazePowder").setPotionEffect(PotionHelper.blazePowderEffect).func_56813_a(CreativeTabs.field_57058_k);
        magmaCream = (new Item(122)).setIconCoord(13, 10).setItemName("magmaCream").setPotionEffect(PotionHelper.magmaCreamEffect).func_56813_a(CreativeTabs.field_57058_k);
        brewingStand = (new ItemReed(123, Block.brewingStand)).setIconCoord(12, 10).setItemName("brewingStand").func_56813_a(CreativeTabs.field_57058_k);
        cauldron = (new ItemReed(124, Block.cauldron)).setIconCoord(12, 9).setItemName("cauldron").func_56813_a(CreativeTabs.field_57058_k);
        speckledMelon = (new Item(126)).setIconCoord(9, 8).setItemName("speckledMelon").setPotionEffect(PotionHelper.speckledMelonEffect).func_56813_a(CreativeTabs.field_57058_k);
        field_55215_bF = (new ItemWritableBook(130)).setIconCoord(11, 11).setItemName("writingBook").func_56813_a(CreativeTabs.field_57046_f);
        diamond = (new Item(132)).setIconCoord(10, 11).setItemName("emerald").func_56813_a(CreativeTabs.field_57055_l);
        StatList.initStats();
    }
}
