...
public class EntityEnderman extends EntityMob
{
    ...
    private boolean shouldAttackPlayer(EntityPlayer par1EntityPlayer)
    {
        ...
        Vec3 vec3_1 = Vec3.func_58128_a().func_58134_a(posX - par1EntityPlayer.posX, (boundingBox.minY + (double)(height / 2.0F)) - (par1EntityPlayer.posY + (double)par1EntityPlayer.getEyeHeight()), posZ - par1EntityPlayer.posZ);
    ...
    {
        Vec3 vec3 = Vec3.func_58128_a().func_58134_a(posX - par1Entity.posX, ((boundingBox.minY + (double)(height / 2.0F)) - par1Entity.posY) + (double)par1Entity.getEyeHeight(), posZ - par1Entity.posZ);
        vec3 = vec3.normalize();
        double d = 16D;
    ...
    public boolean func_56238_A()
    {
        return dataWatcher.getWatchableObjectByte(18) > 0;
    }

    public void func_56239_a(boolean par1)
    {
