...
public class TileEntityMobSpawner extends TileEntity
{
    ...
    private NBTTagCompound field_58020_e;
    public double yaw;
    public double yaw2;
    private int field_58018_f;
    private int field_58019_g;
    private int field_58021_h;
    ...
    public void updateEntity()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < field_58021_h; i++)
            {
                ...
                int j = worldObj.getEntitiesWithinAABB(entityliving.getClass(), AxisAlignedBB.func_58144_a().func_58153_a(xCoord, yCoord, zCoord, xCoord + 1, yCoord + 1, zCoord + 1).expand(8D, 4D, 8D)).size();
                ...
                if (field_58020_e != null)
                {
                    NBTTagCompound nbttagcompound = new NBTTagCompound();
                    entityliving.addEntityID(nbttagcompound);
                    NBTBase nbtbase;

                    for (Iterator iterator = field_58020_e.getTags().iterator(); iterator.hasNext(); nbttagcompound.setTag(nbtbase.getName(), nbtbase.copy()))
                    {
    ...
    {
        delay = field_58018_f + worldObj.rand.nextInt(field_58019_g - field_58018_f);
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            field_58020_e = par1NBTTagCompound.getCompoundTag("SpawnData");
        }
        else
        {
            field_58020_e = null;
        ...
        {
            field_58018_f = par1NBTTagCompound.getShort("MinSpawnDelay");
            field_58019_g = par1NBTTagCompound.getShort("MaxSpawnDelay");
            field_58021_h = par1NBTTagCompound.getShort("SpawnCount");
        }
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setShort("MinSpawnDelay", (short)field_58018_f);
        par1NBTTagCompound.setShort("MaxSpawnDelay", (short)field_58019_g);
        par1NBTTagCompound.setShort("SpawnCount", (short)field_58021_h);

        if (field_58020_e != null)
        {
            par1NBTTagCompound.setCompoundTag("SpawnData", field_58020_e);
        }
    }

    public Packet func_56203_d()
    {
        int i = EntityList.func_56993_a(mobID);
