...
public class GuiEnchantment extends GuiContainer
{
    ...
    protected void mouseClicked(int par1, int par2, int par3)
    {
        ...
        for (int k = 0; k < 3; k++)
        {
            ...
            if (l >= 0 && i1 >= 0 && l < 108 && i1 < 19 && containerEnchantment.enchantItem(mc.field_56455_h, k))
            {
                mc.field_56453_c.func_40593_a(containerEnchantment.windowId, k);
            }
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        GL11.glViewport(((scaledresolution.getScaledWidth() - 320) / 2) * scaledresolution.func_57187_e(), ((scaledresolution.getScaledHeight() - 240) / 2) * scaledresolution.func_57187_e(), 320 * scaledresolution.func_57187_e(), 240 * scaledresolution.func_57187_e());
        ...
        for (int l = 0; l < 3; l++)
        {
            ...
            if (mc.field_56455_h.experienceLevel < i1 && !mc.field_56455_h.capabilities.isCreativeMode)
            {
                drawTexturedModalRect(j + 60, k + 14 + 19 * l, 0, 185, 108, 19);
