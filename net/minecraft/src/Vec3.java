...
public class Vec3
{
    private static final ThreadLocal field_57184_d = new Vec3LocalPool();
    ...
    public static Vec3Pool func_58128_a()
    {
        return (Vec3Pool)field_57184_d.get();
    }
    ...
    {
        return func_58128_a().func_58134_a(par1Vec3.xCoord - xCoord, par1Vec3.yCoord - yCoord, par1Vec3.zCoord - zCoord);
    }
    ...
    public Vec3 normalize()
    {
        ...
        if (d < 0.0001D)
        {
            return func_58128_a().func_58134_a(0.0D, 0.0D, 0.0D);
        }
        else
        {
            return func_58128_a().func_58134_a(xCoord / d, yCoord / d, zCoord / d);
        }
    }
    ...
    {
        return func_58128_a().func_58134_a(yCoord * par1Vec3.zCoord - zCoord * par1Vec3.yCoord, zCoord * par1Vec3.xCoord - xCoord * par1Vec3.zCoord, xCoord * par1Vec3.yCoord - yCoord * par1Vec3.xCoord);
    }
    ...
    {
        return func_58128_a().func_58134_a(xCoord + par1, yCoord + par3, zCoord + par5);
    }
    ...
    public Vec3 getIntermediateWithXValue(Vec3 par1Vec3, double par2)
    {
        ...
        {
            return func_58128_a().func_58134_a(xCoord + d * d3, yCoord + d1 * d3, zCoord + d2 * d3);
        }
    }
    ...
    public void func_57183_c(float par1)
    {
        float f = MathHelper.cos(par1);
        float f1 = MathHelper.sin(par1);
