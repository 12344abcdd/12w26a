...
public class RenderXPOrb extends Render
{
    ...
    public void func_35438_a(EntityXPOrb par1EntityXPOrb, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        float f5 = 0.5F;
        float f6 = 0.25F;
        int f7a = par1EntityXPOrb.getBrightnessForRender(par9);
        int f8a = f7a % 0x10000;
        int j = f7a / 0x10000;
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float)f8a / 1.0F, (float)j / 1.0F);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float f7 = 255F;
        float f8 = ((float)par1EntityXPOrb.xpColor + par9) / 2.0F;
