...
public class ComponentVillageHouse1 extends ComponentVillage
{
    ...
    public static ComponentVillageHouse1 func_56628_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
