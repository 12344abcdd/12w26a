...
public class ItemBlock extends Item
{
    ...
    public boolean func_56812_a(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        if (par3World.canBlockBePlacedAt(blockID, par4, par5, par6, false, par7))
        {
            ...
            if (par3World.setBlockAndMetadataWithNotify(par4, par5, par6, blockID, getMetadata(par1ItemStack.getItemDamage())))
            {
                ...
                {
                    Block.blocksList[blockID].func_56765_a(par3World, par4, par5, par6, par7, par8, par9, par10);
    ...
    {
        return Block.blocksList[blockID].func_56769_v();
    }

    public void func_56814_a(int par1, CreativeTabs par2CreativeTabs, List par3List)
    {
        Block.blocksList[blockID].func_56771_a(par1, par2CreativeTabs, par3List);
    }
}
