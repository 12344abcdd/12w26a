...
public class FontRenderer
{
    ...
    private float alpha;
    private int field_57588_r;
    private boolean field_57587_s;
    private boolean field_57586_t;
    private boolean field_57585_u;
    private boolean field_57584_v;
    private boolean field_57583_w;
    ...
    public int drawStringWithShadow(String par1Str, int par2, int par3, int par4)
    {
        ...
        int i = func_57578_a(par1Str, par2 + 1, par3 + 1, par4, true);
        i = Math.max(i, func_57578_a(par1Str, par2, par3, par4, false));
        return i;
    }
    ...
    public void drawString(String par1Str, int par2, int par3, int par4)
    {
        ...
        func_57578_a(par1Str, par2, par3, par4, false);
    }
    ...
    private void func_57577_a(String par1Str, boolean par2)
    {
        for (int i = 0; i < par1Str.length(); i++)
        {
            ...
            float f = renderCharAtPos(k, c, field_57585_u);

            if (field_57586_t)
            {
                posX++;
                renderCharAtPos(k, c, field_57585_u);
                posX--;
                f++;
            }
    ...
    private int func_57582_a(String par1Str, int par2, int par3, int par4, int par5, boolean par6)
    {
        if (bidiFlag)
        {
            par1Str = bidiReorder(par1Str);
        ...
        return func_57578_a(par1Str, par2, par3, par5, par6);
    }

    private int func_57578_a(String par1Str, int par2, int par3, int par4, boolean par5)
    {
        if (par1Str != null)
        {
            boundTextureName = 0;
    ...
    private String func_55310_c(String par1Str)
    {
    ...
    {
        field_57588_r = par5;
        func_57581_b(par1Str, par2, par3, par4, false);
    }

    private void func_57581_b(String par1Str, int par2, int par3, int par4, boolean par5)
    {
        ...
        if (as.length > 1)
        {
            ...
            for (int k = 0; k < j; k++)
            {
                ...
                func_57581_b(s2, par2, par3, par4, par5);
        ...
        for (; i < as1.length; i++)
        {
            ...
            if (getStringWidth(s1) >= par4)
            {
                if (s.length() > 0)
                {
                    func_57582_a(s, par2, par3, par4, field_57588_r, par5);
                    par3 += FONT_HEIGHT;
                    s = s1;
                }
                ...
                do
                {
                    ...
                    func_57582_a(s1.substring(0, l - 1), par2, par3, par4, field_57588_r, par5);
                    par3 += FONT_HEIGHT;
                    s1 = s1.substring(l - 1);
                }
