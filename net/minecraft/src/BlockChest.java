...
public class BlockChest extends BlockContainer
{
    ...
    protected BlockChest(int par1)
    {
        ...
        func_56773_a(CreativeTabs.field_57051_c);
    }
    ...
    {
        for (Iterator iterator = par0World.getEntitiesWithinAABB(net.minecraft.src.EntityOcelot.class, AxisAlignedBB.func_58144_a().func_58153_a(par1, par2 + 1, par3, par1 + 1, par2 + 2, par3 + 1)).iterator(); iterator.hasNext();)
        {
