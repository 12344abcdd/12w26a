...
public class ChunkCache implements IBlockAccess
{
    ...
    public int getLightValueExt(int par1, int par2, int par3, boolean par4)
    {
        ...
        if (par4)
        {
            ...
            if (i == Block.field_55202_ak.blockID || i == Block.field_55205_bO.blockID || i == Block.tilledField.blockID || i == Block.stairCompactPlanks.blockID || i == Block.stairCompactCobblestone.blockID)
            {
