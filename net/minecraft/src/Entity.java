...
public abstract class Entity
{
    ...
    public EnumEntitySize field_55082_am;
    ...
    public Entity(World par1World)
    {
        ...
        addedToChunk = false;
        field_55082_am = EnumEntitySize.SIZE_2;
        worldObj = par1World;
    ...
    protected void setSize(float par1, float par2)
    {
        ...
        if ((double)f < 0.375D)
        {
            field_55082_am = EnumEntitySize.SIZE_1;
        }
        ...
        {
            field_55082_am = EnumEntitySize.SIZE_3;
        }
        else if ((double)f < 1.375D)
        {
            field_55082_am = EnumEntitySize.SIZE_4;
        }
        else if ((double)f < 1.75D)
        {
            field_55082_am = EnumEntitySize.SIZE_5;
        }
        else
        {
            field_55082_am = EnumEntitySize.SIZE_6;
        }
    }
    ...
    public void func_55081_i(Entity par1Entity)
    {
        ...
        for (double d3 = -1.5D; d3 < 2D; d3 += 1.5D)
        {
            for (double d4 = -1.5D; d4 < 2D; d4 += 1.5D)
            {
                ...
                if (!worldObj.func_55267_a(axisalignedbb).isEmpty())
                {
                    continue;
                }

                if (worldObj.func_58081_i(i, (int)posY, j))
                {
                    setLocationAndAngles(posX + d3, posY + 1.0D, posZ + d4, rotationYaw, rotationPitch);
                    return;
                }

                if (worldObj.func_58081_i(i, (int)posY - 1, j) || worldObj.getBlockMaterial(i, (int)posY - 1, j) == Material.water)
                {
                    d = posX + d3;
                    d1 = posY + 1.0D;
                    d2 = posZ + d4;
    ...
    public void func_56179_b(int i, ItemStack itemstack)
    {
    }
    ...
    public String toString()
    {
        return String.format("%s['%s'/%d, l='%s', x=%.2f, y=%.2f, z=%.2f]", new Object[]
                {
                    getClass().getSimpleName(), func_55080_n(), Integer.valueOf(entityId), worldObj != null ? worldObj.getWorldInfo().getWorldName() : "~NULL~", Double.valueOf(posX), Double.valueOf(posY), Double.valueOf(posZ)
                });
    }
}
