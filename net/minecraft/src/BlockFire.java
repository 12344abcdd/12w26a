...
public class BlockFire extends Block
{
    ...
    public void initializeBlock()
    {
        ...
        setBurnRate(Block.field_55204_bN.blockID, 5, 20);
        setBurnRate(Block.field_55205_bO.blockID, 5, 20);
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            if (!par1World.func_58081_i(par2, par3 - 1, par4) || i > 3)
            {
                par1World.setBlockWithNotify(par2, par3, par4, 0);
            }
    ...
    {
        return par1World.func_58081_i(par2, par3 - 1, par4) || canNeighborBurn(par1World, par2, par3, par4);
    }
    ...
    {
        if (!par1World.func_58081_i(par2, par3 - 1, par4) && !canNeighborBurn(par1World, par2, par3, par4))
        {
            par1World.setBlockWithNotify(par2, par3, par4, 0);
        }
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            par1World.func_56841_a((float)par2 + 0.5F, (float)par3 + 0.5F, (float)par4 + 0.5F, "fire.fire", 1.0F + par5Random.nextFloat(), par5Random.nextFloat() * 0.7F + 0.3F);
        }

        if (par1World.func_58081_i(par2, par3 - 1, par4) || Block.fire.canBlockCatchFire(par1World, par2, par3 - 1, par4))
        {
            for (int i = 0; i < 3; i++)
            {
