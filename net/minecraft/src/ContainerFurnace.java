...
public class ContainerFurnace extends Container
{
    ...
    public ContainerFurnace(InventoryPlayer par1InventoryPlayer, TileEntityFurnace par2TileEntityFurnace)
    {
        ...
        func_55197_a(new Slot(par2TileEntityFurnace, 0, 56, 17));
        func_55197_a(new Slot(par2TileEntityFurnace, 1, 56, 53));
        func_55197_a(new SlotFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
