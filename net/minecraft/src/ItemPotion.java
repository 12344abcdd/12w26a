...
public class ItemPotion extends Item
{
    ...
    private static final Map field_56833_b = new LinkedHashMap();
    ...
    public ItemPotion(int par1)
    {
        ...
        setHasSubtypes(true);
        setMaxDamage(0);
        func_56813_a(CreativeTabs.field_57058_k);
    }
    ...
    {
        super.func_56814_a(par1, par2CreativeTabs, par3List);

        if (field_56833_b.isEmpty())
        {
            for (int i = 0; i <= 32767; i++)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    field_56833_b.put(list, Integer.valueOf(i));
                }
            }
        }
        ...
        for (Iterator iterator = field_56833_b.values().iterator(); iterator.hasNext(); par3List.add(new ItemStack(par1, 1, j)))
        {
