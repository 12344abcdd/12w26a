...
public class EntityAIMoveTwardsRestriction extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        Vec3 vec3 = RandomPositionGenerator.func_48620_a(theEntity, 16, 7, Vec3.func_58128_a().func_58134_a(chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ));
