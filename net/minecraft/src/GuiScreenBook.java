    ...
    private void func_55118_a(boolean par1)
    {
        ...
        if (field_55129_l != null)
        {
            do
            {
                ...
                field_55129_l.func_55176_a(field_55129_l.tagCount() - 1);
            }
            while (true);
            ...
            {
                field_55124_b.func_55397_a("pages", field_55129_l);
            }
            ...
            {
                s = "MC|BSign";
                field_55124_b.func_55397_a("author", new NBTTagString("author", field_55126_a.username));
                field_55124_b.func_55397_a("title", new NBTTagString("title", field_55130_m.trim()));
                field_55124_b.itemID = Item.field_55216_bG.shiftedIndex;
            }
            ...
            try
            {
                Packet.writeItemStack(field_55124_b, dataoutputstream);
