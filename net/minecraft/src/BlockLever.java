...
public class BlockLever extends Block
{
    ...
    public boolean canPlaceBlockOnSide(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (par5 == 1 && par1World.func_58081_i(par2, par3 - 1, par4))
        {
            return true;
        }
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4)
    {
        ...
        if (par1World.func_58081_i(par2, par3 - 1, par4))
        {
            return true;
        }
    ...
    public static int func_56803_e(int par0)
    {
        switch (par0)
        {
            case 0:
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        if (checkIfAttachedToBlock(par1World, par2, par3, par4))
        {
            ...
            if (!par1World.func_58081_i(par2, par3 - 1, par4) && i == 5)
            {
                flag = true;
            }

            if (!par1World.func_58081_i(par2, par3 - 1, par4) && i == 6)
            {
                flag = true;
            }
    ...
    {
        func_56764_a(par1World, par2, par3, par4, par5EntityPlayer, 0, 0.0F, 0.0F, 0.0F);
    }
