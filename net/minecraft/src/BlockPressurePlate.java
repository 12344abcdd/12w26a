...
public class BlockPressurePlate extends Block
{
    ...
    {
        return par1World.func_58081_i(par2, par3 - 1, par4) || BlockFence.func_56782_e(par1World.getBlockId(par2, par3 - 1, par4));
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (!par1World.func_58081_i(par2, par3 - 1, par4) && !BlockFence.func_56782_e(par1World.getBlockId(par2, par3 - 1, par4)))
        {
            flag = true;
        }
    ...
    private void setStateIfMobInteractsWithPlate(World par1World, int par2, int par3, int par4)
    {
        ...
        {
            list = par1World.getEntitiesWithinAABBExcludingEntity(null, AxisAlignedBB.func_58144_a().func_58153_a((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, (double)par3 + 0.25D, (float)(par4 + 1) - f));
        }

        if (triggerMobType == EnumMobType.mobs)
        {
            list = par1World.getEntitiesWithinAABB(net.minecraft.src.EntityLiving.class, AxisAlignedBB.func_58144_a().func_58153_a((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, (double)par3 + 0.25D, (float)(par4 + 1) - f));
        }

        if (triggerMobType == EnumMobType.players)
        {
            list = par1World.getEntitiesWithinAABB(net.minecraft.src.EntityPlayer.class, AxisAlignedBB.func_58144_a().func_58153_a((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, (double)par3 + 0.25D, (float)(par4 + 1) - f));
        }
