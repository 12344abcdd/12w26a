...
public class StatList
{
    ...
    private static void replaceAllSimilarBlocks(StatBase par0ArrayOfStatBase[])
    {
        ...
        replaceSimilarBlocks(par0ArrayOfStatBase, Block.field_55203_aj.blockID, Block.field_55202_ak.blockID);
        replaceSimilarBlocks(par0ArrayOfStatBase, Block.field_55204_bN.blockID, Block.field_55205_bO.blockID);
