...
public class SaveHandler implements ISaveHandler, IPlayerFileData
{
    ...
    public void func_56805_a(WorldInfo par1WorldInfo, NBTTagCompound par2NBTTagCompound)
    {
        NBTTagCompound nbttagcompound = par1WorldInfo.func_56912_a(par2NBTTagCompound);
    ...
    public void func_56809_a(EntityPlayer par1EntityPlayer)
    {
        try
        {
    ...
    public void func_56807_b(EntityPlayer par1EntityPlayer)
    {
        NBTTagCompound nbttagcompound = func_56810_a(par1EntityPlayer.username);
    ...
    public NBTTagCompound func_56810_a(String par1Str)
    {
        try
        {
    ...
    public IPlayerFileData func_56804_d()
    {
        return this;
    }

    public String[] func_56808_e()
    {
