...
public class GuiIngame extends Gui
{
    ...
    private final GuiNewChat field_55094_f;
    ...
    public GuiIngame(Minecraft par1Minecraft)
    {
        ...
        mc = par1Minecraft;
        field_55094_f = new GuiNewChat(par1Minecraft);
    }
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        {
            renderVignette(mc.field_56455_h.getBrightness(par1), i, j);
        }
        else
        {
        ...
        ItemStack itemstack = mc.field_56455_h.inventory.armorItemInSlot(3);
        ...
        if (!mc.field_56455_h.isPotionActive(Potion.confusion))
        {
            float f = mc.field_56455_h.prevTimeInPortal + (mc.field_56455_h.timeInPortal - mc.field_56455_h.prevTimeInPortal) * par1;
        ...
        if (!mc.field_56453_c.func_57519_a())
        {
            ...
            boolean flag = (mc.field_56455_h.heartsLife / 3) % 2 == 1;

            if (mc.field_56455_h.heartsLife < 10)
            {
                flag = false;
            }

            int i1 = mc.field_56455_h.getHealth();
            int j2 = mc.field_56455_h.prevHealth;
            rand.setSeed(updateCounter * 0x4c627);
            boolean flag2 = false;
            FoodStats foodstats = mc.field_56455_h.getFoodStats();
            int j4 = foodstats.getFoodLevel();
            int i5 = foodstats.getPrevFoodLevel();
            renderBossHealth();

            if (mc.field_56453_c.shouldDrawHUD())
            {
                int k5 = i / 2 - 91;
                int j6 = i / 2 + 91;
                int i7 = mc.field_56455_h.xpBarCap();

                if (i7 > 0)
                {
                    char c = '\266';
                    int k8 = (int)(mc.field_56455_h.experience * (float)(c + 1));
                    int j9 = (j - 32) + 3;
                ...
                int l7 = j - 39;
                int l8 = l7 - 10;
                int k9 = mc.field_56455_h.getTotalArmorValue();
                int j10 = -1;

                if (mc.field_56455_h.isPotionActive(Potion.regeneration))
                {
                ...
                for (int k10 = 0; k10 < 10; k10++)
                {
                    ...
                    if (mc.field_56455_h.isPotionActive(Potion.poison))
                    {
                        k11 += 36;
                    }
                    ...
                    if (mc.field_56452_f.getWorldInfo().isHardcoreModeEnabled())
                    {
                        byte3 = 5;
                    }
                ...
                for (int l10 = 0; l10 < 10; l10++)
                {
                    ...
                    if (mc.field_56455_h.isPotionActive(Potion.hunger))
                    {
                        k12 += 36;
                        byte2 = 13;
                    }

                    if (mc.field_56455_h.getFoodStats().getSaturationLevel() <= 0.0F && updateCounter % (j4 * 3 + 1) == 0)
                    {
                ...
                if (mc.field_56455_h.isInsideOfMaterial(Material.water))
                {
                    int i11 = mc.field_56455_h.getAir();
        ...
        if (mc.field_56455_h.getSleepTimer() > 0)
        {
            GL11.glDisable(GL11.GL_DEPTH_TEST);
            GL11.glDisable(GL11.GL_ALPHA_TEST);
            int k = mc.field_56455_h.getSleepTimer();
        ...
        if (mc.field_56453_c.func_35642_f() && mc.field_56455_h.experienceLevel > 0)
        {
            boolean flag1 = false;
            int k1 = flag1 ? 0xffffff : 0x80ff20;
            String s1 = (new StringBuilder()).append("").append(mc.field_56455_h.experienceLevel).toString();
        ...
        if (mc.func_55063_q())
        {
            ...
            if (mc.field_56452_f.getWorldTime() >= 0x1d6b4L)
            {
            ...
            else
            {
                s = String.format(StatCollector.translateToLocal("demo.remainingTime"), new Object[]
                        {
                            StringUtils.func_55393_a((int)(0x1d6b4L - mc.field_56452_f.getWorldTime()))
                        });
            }
        ...
        {
            GL11.glPushMatrix();
            fontrenderer.drawStringWithShadow((new StringBuilder()).append("Minecraft 12w26a (").append(mc.debug).append(")").toString(), 2, 2, 0xffffff);
            ...
            drawString(fontrenderer, String.format("x: %.5f", new Object[]
                    {
                        Double.valueOf(mc.field_56455_h.posX)
                    }), 2, 64, 0xe0e0e0);
            drawString(fontrenderer, String.format("y: %.5f", new Object[]
                    {
                        Double.valueOf(mc.field_56455_h.posY)
                    }), 2, 72, 0xe0e0e0);
            drawString(fontrenderer, String.format("z: %.5f", new Object[]
                    {
                        Double.valueOf(mc.field_56455_h.posZ)
                    }), 2, 80, 0xe0e0e0);
            drawString(fontrenderer, (new StringBuilder()).append("f: ").append(MathHelper.floor_double((double)((mc.field_56455_h.rotationYaw * 4F) / 360F) + 0.5D) & 3).toString(), 2, 88, 0xe0e0e0);
            int i8 = MathHelper.floor_double(mc.field_56455_h.posX);
            int i9 = MathHelper.floor_double(mc.field_56455_h.posY);
            int l9 = MathHelper.floor_double(mc.field_56455_h.posZ);

            if (mc.field_56452_f != null && mc.field_56452_f.blockExists(i8, i9, l9))
            {
                Chunk chunk = mc.field_56452_f.getChunkFromBlockCoords(i8, l9);
                drawString(fontrenderer, (new StringBuilder()).append("lc: ").append(chunk.getTopFilledSegment() + 15).append(" b: ").append(chunk.func_48490_a(i8 & 0xf, l9 & 0xf, mc.field_56452_f.getWorldChunkManager()).biomeName).append(" bl: ").append(chunk.getSavedLightValue(EnumSkyBlock.Block, i8 & 0xf, i9, l9 & 0xf)).append(" sl: ").append(chunk.getSavedLightValue(EnumSkyBlock.Sky, i8 & 0xf, i9, l9 & 0xf)).append(" rl: ").append(chunk.getBlockLightValue(i8 & 0xf, i9, l9 & 0xf, 0)).toString(), 2, 96, 0xe0e0e0);
            }

            drawString(fontrenderer, String.format("ws: %.3f, fs: %.3f, g: %b", new Object[]
                    {
                        Float.valueOf(mc.field_56455_h.capabilities.func_57528_b()), Float.valueOf(mc.field_56455_h.capabilities.func_57527_a()), Boolean.valueOf(mc.field_56455_h.onGround)
                    }), 2, 104, 0xe0e0e0);
            GL11.glPopMatrix();
        }
        ...
        field_55094_f.func_55102_a(updateCounter);
        GL11.glPopMatrix();

        if (mc.gameSettings.keyBindPlayerList.pressed && (!mc.func_56444_A() || mc.field_56455_h.sendQueue.playerNames.size() > 1))
        {
            NetClientHandler netclienthandler = mc.field_56455_h.sendQueue;
    ...
    {
        ItemStack itemstack = mc.field_56455_h.inventory.mainInventory[par1];
    ...
    public GuiNewChat func_55092_b()
    {
        return field_55094_f;
    }

    public int func_55093_c()
    {
