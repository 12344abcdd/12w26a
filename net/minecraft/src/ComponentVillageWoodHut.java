...
public class ComponentVillageWoodHut extends ComponentVillage
{
    ...
    public static ComponentVillageWoodHut func_56629_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
