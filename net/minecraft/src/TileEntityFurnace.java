...
public class TileEntityFurnace extends TileEntity implements IInventory
{
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        if ((item instanceof ItemTool) && ((ItemTool)item).func_56820_c().equals("WOOD"))
        {
            return 200;
        }

        if ((item instanceof ItemSword) && ((ItemSword)item).func_56828_d().equals("WOOD"))
        {
            return 200;
        }

        if ((item instanceof ItemHoe) && ((ItemHoe)item).func_56829_d().equals("WOOD"))
        {
            return 200;
        }
