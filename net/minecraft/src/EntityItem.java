...
public class EntityItem extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if (flag)
        {
            ...
            for (Iterator iterator = worldObj.getEntitiesWithinAABB(net.minecraft.src.EntityItem.class, boundingBox.expand(0.5D, 0.0D, 0.5D)).iterator(); iterator.hasNext(); func_55083_a(entityitem))
            {
    ...
    public boolean func_55083_a(EntityItem par1EntityItem)
    {
        ...
        {
            return par1EntityItem.func_55083_a(this);
        }
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        ...
        if (delayBeforeCanPickup == 0 && par1EntityPlayer.inventory.addItemStackToInventory(item))
        {
            ...
            if (item.itemID == Item.field_56819_n.shiftedIndex)
            {
    ...
    {
        return StatCollector.translateToLocal((new StringBuilder()).append("item.").append(item.func_55396_l()).toString());
    }
