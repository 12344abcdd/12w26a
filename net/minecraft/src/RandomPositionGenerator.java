...
public class RandomPositionGenerator
{
    ...
    public static Vec3 func_48620_a(EntityCreature par0EntityCreature, int par1, int par2, Vec3 par3Vec3)
    {
        field_48624_a.xCoord = par3Vec3.xCoord - par0EntityCreature.posX;
        field_48624_a.yCoord = par3Vec3.yCoord - par0EntityCreature.posY;
        field_48624_a.zCoord = par3Vec3.zCoord - par0EntityCreature.posZ;
        return func_48621_c(par0EntityCreature, par1, par2, field_48624_a);
    }

    public static Vec3 func_48623_b(EntityCreature par0EntityCreature, int par1, int par2, Vec3 par3Vec3)
    {
        field_48624_a.xCoord = par0EntityCreature.posX - par3Vec3.xCoord;
        field_48624_a.yCoord = par0EntityCreature.posY - par3Vec3.yCoord;
        field_48624_a.zCoord = par0EntityCreature.posZ - par3Vec3.zCoord;
        return func_48621_c(par0EntityCreature, par1, par2, field_48624_a);
    }

    private static Vec3 func_48621_c(EntityCreature par0EntityCreature, int par1, int par2, Vec3 par3Vec3)
    {
        ...
        if (flag)
        {
            return Vec3.func_58128_a().func_58134_a(i, j, k);
        }
        else
        {
            return null;
