    ...
    public void initGui()
    {
        ...
        for (int k = 0; k < j; k++)
        {
            ...
            else
            {
                ...
                if (enumoptions == EnumOptions.DIFFICULTY && mc.field_56452_f != null && mc.field_56452_f.getWorldInfo().isHardcoreModeEnabled())
                {
        ...
        controlList.add(new GuiButton(200, width / 2 - 100, height / 6 + 144, stringtranslate.translateKey("gui.done")));
    }
