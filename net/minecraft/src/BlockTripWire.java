...
public class BlockTripWire extends Block
{
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        boolean flag = (i & 2) == 2;
        boolean flag1 = !par1World.func_58081_i(par2, par3 - 1, par4);
    ...
    {
        byte byte0 = ((byte)(par1World.func_58081_i(par2, par3 - 1, par4) ? 0 : 2));
    ...
    private void func_56790_e(World par1World, int par2, int par3, int par4, int par5)
    {
        for (int i = 0; i < 2; i++)
        {
            for (int j = 1; j < 42; j++)
            {
                ...
                if (i1 == Block.field_56776_bT.blockID)
                {
                    Block.field_56776_bT.func_56799_a(par1World, k, par3, l, i1, par1World.getBlockMetadata(k, par3, l), true, j, par5);
                    continue;
                }

                if (i1 != Block.field_56775_bU.blockID)
                {
                    break;
                }
            }
    ...
    private void func_56789_j(World par1World, int par2, int par3, int par4)
    {
        ...
        boolean flag = (i & 1) == 1;
        boolean flag1 = false;
        List list = par1World.getEntitiesWithinAABBExcludingEntity(null, AxisAlignedBB.func_58144_a().func_58153_a((double)par2 + minX, (double)par3 + minY, (double)par4 + minZ, (double)par2 + maxX, (double)par3 + maxY, (double)par4 + maxZ));
    ...
    public static boolean func_56788_a(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4, int par5)
    {
        ...
        if (l == Block.field_56776_bT.blockID)
        {
        ...
        if (l == Block.field_56775_bU.blockID)
        {
