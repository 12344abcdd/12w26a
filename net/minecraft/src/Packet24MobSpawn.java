...
public class Packet24MobSpawn extends Packet
{
    ...
    public Packet24MobSpawn(EntityLiving par1EntityLiving)
    {
        ...
        xPosition = par1EntityLiving.field_55082_am.func_55257_a(par1EntityLiving.posX);
        yPosition = MathHelper.floor_double(par1EntityLiving.posY * 32D);
        zPosition = par1EntityLiving.field_55082_am.func_55257_a(par1EntityLiving.posZ);
    ...
    public List getMetadata()
    {
        ...
        {
            receivedMetadata = metaData.func_57622_c();
        }
