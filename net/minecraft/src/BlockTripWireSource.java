...
public class BlockTripWireSource extends Block
{
    ...
    public void func_56799_a(World par1World, int par2, int par3, int par4, int par5, int par6, boolean par7, int par8, int par9)
    {
        ...
        boolean flag2 = par5 == Block.field_56776_bT.blockID;
        boolean flag3 = false;
        boolean flag4 = !par1World.func_58081_i(par2, par3 - 1, par4);
        ...
        for (int i1 = 1; i1 < 42; i1++)
        {
            ...
            if (i3 == Block.field_56776_bT.blockID)
            {
            ...
            if (i3 == Block.field_56775_bU.blockID || i1 == par8)
            {
