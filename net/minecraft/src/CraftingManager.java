...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        addShapelessRecipe(new ItemStack(Item.field_55215_bF, 1), new Object[]
                {
        ...
        addRecipe(new ItemStack(Block.jukebox, 1), new Object[]
                {
                    "###", "#X#", "###", '#', Block.planks, 'X', Item.field_56819_n
                });
        ...
        addRecipe(new ItemStack(Block.field_55202_ak, 6, 3), new Object[]
                {
                    "###", '#', Block.cobblestone
                });
        addRecipe(new ItemStack(Block.field_55202_ak, 6, 0), new Object[]
                {
                    "###", '#', Block.stone
                });
        addRecipe(new ItemStack(Block.field_55202_ak, 6, 1), new Object[]
                {
                    "###", '#', Block.sandStone
                });
        addRecipe(new ItemStack(Block.field_55202_ak, 6, 4), new Object[]
                {
                    "###", '#', Block.brick
                });
        addRecipe(new ItemStack(Block.field_55202_ak, 6, 5), new Object[]
                {
                    "###", '#', Block.stoneBrick
                });
        addRecipe(new ItemStack(Block.field_55205_bO, 6, 0), new Object[]
                {
                    "###", '#', new ItemStack(Block.planks, 1, 0)
                });
        addRecipe(new ItemStack(Block.field_55205_bO, 6, 2), new Object[]
                {
                    "###", '#', new ItemStack(Block.planks, 1, 2)
                });
        addRecipe(new ItemStack(Block.field_55205_bO, 6, 1), new Object[]
                {
                    "###", '#', new ItemStack(Block.planks, 1, 1)
                });
        addRecipe(new ItemStack(Block.field_55205_bO, 6, 3), new Object[]
                {
        ...
        addRecipe(new ItemStack(Block.field_58075_bX, 4), new Object[]
                {
                    "#  ", "## ", "###", '#', new ItemStack(Block.planks, 1, 2)
                });
        addRecipe(new ItemStack(Block.field_58076_bW, 4), new Object[]
                {
                    "#  ", "## ", "###", '#', new ItemStack(Block.planks, 1, 1)
                });
        addRecipe(new ItemStack(Block.field_58074_bY, 4), new Object[]
                {
                    "#  ", "## ", "###", '#', new ItemStack(Block.planks, 1, 3)
                });
        ...
        addRecipe(new ItemStack(Block.field_56781_bQ, 4), new Object[]
                {
                    "#  ", "## ", "###", '#', Block.sandStone
                });
        ...
        addRecipe(new ItemStack(Block.field_56776_bT, 2), new Object[]
                {
        ...
        addRecipe(new ItemStack(Block.enchantmentTable, 1), new Object[]
                {
                    " B ", "D#D", "###", '#', Block.obsidian, 'B', Item.book, 'D', Item.field_56819_n
                });
