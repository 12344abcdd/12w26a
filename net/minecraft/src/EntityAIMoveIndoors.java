...
public class EntityAIMoveIndoors extends EntityAIBase
{
    ...
    public void startExecuting()
    {
        ...
        {
            Vec3 vec3 = RandomPositionGenerator.func_48620_a(entityObj, 14, 3, Vec3.func_58128_a().func_58134_a((double)doorInfo.getInsidePosX() + 0.5D, doorInfo.getInsidePosY(), (double)doorInfo.getInsidePosZ() + 0.5D));
