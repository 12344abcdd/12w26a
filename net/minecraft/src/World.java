...
public abstract class World implements IBlockAccess
{
    ...
    public World(ISaveHandler par1ISaveHandler, String par2Str, WorldSettings par3WorldSettings, WorldProvider par4WorldProvider)
    {
        ...
        if (!worldInfo.func_56914_v())
        {
            func_56842_a(par3WorldSettings);
            worldInfo.func_56913_c(true);
        }
    ...
    public boolean func_56838_k(int par1, int par2, int par3)
    {
    ...
    public int getBlockLightValue_do(int par1, int par2, int par3, boolean par4)
    {
        ...
        if (par4)
        {
            ...
            if (i == Block.field_55202_ak.blockID || i == Block.field_55205_bO.blockID || i == Block.tilledField.blockID || i == Block.stairCompactCobblestone.blockID || i == Block.stairCompactPlanks.blockID)
            {
    ...
    public MovingObjectPosition rayTraceBlocks_do_do(Vec3 par1Vec3, Vec3 par2Vec3, boolean par3, boolean par4)
    {
        ...
        for (int l1 = 200; l1-- >= 0;)
        {
            ...
            Vec3 vec3 = Vec3.func_58128_a().func_58134_a(par1Vec3.xCoord, par1Vec3.yCoord, par1Vec3.zCoord);
    ...
    public void func_56841_a(double d, double d1, double d2, String s, float f, float f1)
    {
    }
    ...
    public void func_56839_f(Entity par1Entity)
    {
        par1Entity.setDead();
        ...
        for (int k1 = i; k1 < j; k1++)
        {
            for (int l1 = i1; l1 < j1; l1++)
            {
                ...
                for (int i2 = k - 1; i2 < l; i2++)
                {
                    ...
                    if (block != null)
                    {
                        block.func_56763_a(this, k1, i2, l1, par2AxisAlignedBB, collidingBoundingBoxes, par1Entity);
                    }
                }
            }
        }
    ...
    public List func_55267_a(AxisAlignedBB par1AxisAlignedBB)
    {
        collidingBoundingBoxes.clear();
        ...
        for (int k1 = i; k1 < j; k1++)
        {
            for (int l1 = i1; l1 < j1; l1++)
            {
                ...
                for (int i2 = k - 1; i2 < l; i2++)
                {
                    ...
                    if (block != null)
                    {
                        block.func_56763_a(this, k1, i2, l1, par1AxisAlignedBB, collidingBoundingBoxes, null);
                    }
                }
            }
        }
    ...
    public Vec3 getSkyColor(Entity par1Entity, float par2)
    {
        ...
        return Vec3.func_58128_a().func_58134_a(f3, f4, f5);
    }
    ...
    public Vec3 drawClouds(float par1)
    {
        ...
        return Vec3.func_58128_a().func_58134_a(f2, f3, f4);
    }
    ...
    public void updateEntities()
    {
        ...
        do
        {
            ...
            if (!tileentity.isInvalid() && tileentity.func_56201_k() && blockExists(tileentity.xCoord, tileentity.yCoord, tileentity.zCoord))
            {
    ...
    public boolean func_56840_c(AxisAlignedBB par1AxisAlignedBB)
    {
        int i = MathHelper.floor_double(par1AxisAlignedBB.minX);
        int j = MathHelper.floor_double(par1AxisAlignedBB.maxX + 1.0D);
        int k = MathHelper.floor_double(par1AxisAlignedBB.minY);
    ...
    public boolean handleMaterialAcceleration(AxisAlignedBB par1AxisAlignedBB, Material par2Material, Entity par3Entity)
    {
        ...
        boolean flag = false;
        Vec3 vec3 = Vec3.func_58128_a().func_58134_a(0.0D, 0.0D, 0.0D);
        ...
        for (float f = 0.0F; f <= 1.0F; f = (float)((double)f + d))
        {
            for (float f1 = 0.0F; f1 <= 1.0F; f1 = (float)((double)f1 + d1))
            {
                for (float f2 = 0.0F; f2 <= 1.0F; f2 = (float)((double)f2 + d2))
                {
                    ...
                    if (rayTraceBlocks(Vec3.func_58128_a().func_58134_a(d3, d4, d5), par1Vec3) == null)
                    {
                        i++;
                    }
    ...
    public boolean func_58081_i(int par1, int par2, int par3)
    {
        Block block = Block.blocksList[getBlockId(par1, par2, par3)];
    ...
    public CrashReport func_55266_a(CrashReport par1CrashReport)
    {
        par1CrashReport.func_55366_a((new StringBuilder()).append("World ").append(worldInfo.getWorldName()).append(" Entities").toString(), new CallableLvl1(this));
        par1CrashReport.func_55366_a((new StringBuilder()).append("World ").append(worldInfo.getWorldName()).append(" Players").toString(), new CallableLvl2(this));
        par1CrashReport.func_55366_a((new StringBuilder()).append("World ").append(worldInfo.getWorldName()).append(" Chunk Stats").toString(), new CallableLvl3(this));
        return par1CrashReport;
    }

    public void func_56837_h(int par1, int par2, int par3, int par4, int par5)
    {
        IWorldAccess iworldaccess;

        for (Iterator iterator = worldAccesses.iterator(); iterator.hasNext(); iworldaccess.func_56643_a(par1, par2, par3, par4, par5))
        {
            iworldaccess = (IWorldAccess)iterator.next();
        }
    }
