...
public abstract class StructureComponent
{
    ...
    protected int getMetadataWithOffset(int par1, int par2)
    {
        ...
        else if (par1 == Block.stairCompactCobblestone.blockID || par1 == Block.stairCompactPlanks.blockID || par1 == Block.stairsNetherBrick.blockID || par1 == Block.stairsStoneBrickSmooth.blockID || par1 == Block.field_56781_bQ.blockID)
        {
            if (coordBaseMode == 0)
            {
                if (par2 == 2)
        ...
        else if (par1 == Block.field_56776_bT.blockID || Block.blocksList[par1] != null && (Block.blocksList[par1] instanceof BlockDirectional))
        {
            if (coordBaseMode == 0)
            {
                if (par2 == 0 || par2 == 2)
    ...
    protected void func_56601_a(World par1World, StructureBoundingBox par2StructureBoundingBox, int par3, int par4, int par5, int par6, int par7, int par8)
    {
    ...
    protected void func_56602_a(World par1World, StructureBoundingBox par2StructureBoundingBox, int par3, int par4, int par5, int par6, int par7, int par8, int par9, int par10, int par11, int par12, boolean par13)
    {
        for (int i = par4; i <= par7; i++)
        {
            for (int j = par3; j <= par6; j++)
    ...
    protected boolean func_56600_a(World par1World, StructureBoundingBox par2StructureBoundingBox, Random par3Random, int par4, int par5, int par6, WeightedRandomChestContent par7ArrayOfWeightedRandomChestContent[], int par8)
    {
        int i = getXWithOffset(par4, par6);
        int j = getYWithOffset(par5);
        int k = getZWithOffset(par4, par6);
        ...
        if (par2StructureBoundingBox.isVecInside(i, j, k) && par1World.getBlockId(i, j, k) != Block.chest.blockID)
        {
            ...
            {
                WeightedRandomChestContent.func_55297_a(par3Random, par7ArrayOfWeightedRandomChestContent, tileentitychest, par8);
            }
    ...
    protected boolean func_56599_a(World par1World, StructureBoundingBox par2StructureBoundingBox, Random par3Random, int par4, int par5, int par6, int par7, WeightedRandomChestContent par8ArrayOfWeightedRandomChestContent[], int par9)
    {
        int i = getXWithOffset(par4, par6);
        int j = getYWithOffset(par5);
        int k = getZWithOffset(par4, par6);
        ...
        if (par2StructureBoundingBox.isVecInside(i, j, k) && par1World.getBlockId(i, j, k) != Block.dispenser.blockID)
        {
            ...
            {
                WeightedRandomChestContent.func_56895_a(par3Random, par8ArrayOfWeightedRandomChestContent, tileentitydispenser, par9);
            }
