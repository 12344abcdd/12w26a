...
public class EntityDragon extends EntityDragonBase
{
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            Vec3 vec3 = Vec3.func_58128_a().func_58134_a(targetX - posX, targetY - posY, targetZ - posZ).normalize();
            Vec3 vec3_1 = Vec3.func_58128_a().func_58134_a(MathHelper.sin((rotationYaw * (float)Math.PI) / 180F), motionY, -MathHelper.cos((rotationYaw * (float)Math.PI) / 180F)).normalize();
            ...
            Vec3 vec3_2 = Vec3.func_58128_a().func_58134_a(motionX, motionY, motionZ).normalize();
    ...
    protected void onDeathUpdate()
    {
        ...
        if (field_40178_aA == 200 && !worldObj.isRemote)
        {
            for (int j = 2000; j > 0;)
            {
