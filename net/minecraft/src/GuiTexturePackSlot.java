...
class GuiTexturePackSlot extends GuiSlot
{
    ...
    {
        return GuiTexturePacks.func_22126_b(parentTexturePackGui).texturePackList.availableTexturePacks().size();
    }
    ...
    protected boolean isSelected(int par1)
    {
        ...
        return GuiTexturePacks.func_22116_g(parentTexturePackGui).texturePackList.func_55278_c() == list.get(par1);
    }
    ...
    protected void drawSlot(int par1, int par2, int par3, int par4, Tessellator par5Tessellator)
    {
        ...
        texturepackbase.func_55181_b(GuiTexturePacks.func_22123_i(parentTexturePackGui).renderEngine);
        ...
        parentTexturePackGui.drawString(GuiTexturePacks.func_22127_j(parentTexturePackGui), texturepackbase.func_55180_b(), par2 + 32 + 2, par3 + 1, 0xffffff);
        parentTexturePackGui.drawString(GuiTexturePacks.func_22120_k(parentTexturePackGui), texturepackbase.func_55182_c(), par2 + 32 + 2, par3 + 12, 0x808080);
        parentTexturePackGui.drawString(GuiTexturePacks.func_22125_l(parentTexturePackGui), texturepackbase.func_55177_d(), par2 + 32 + 2, par3 + 12 + 10, 0x808080);
    }
}
