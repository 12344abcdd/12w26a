...
{
    protected Map field_55220_e;

    public MapGenStructure()
    {
        field_55220_e = new HashMap();
    }
    ...
    {
        if (field_55220_e.containsKey(Long.valueOf(ChunkCoordIntPair.chunkXZ2Int(par2, par3))))
        {
            return;
        }
        ...
        if (canSpawnStructureAtCoords(par2, par3))
        {
            ...
            field_55220_e.put(Long.valueOf(ChunkCoordIntPair.chunkXZ2Int(par2, par3)), structurestart);
        }
    }
    ...
    public boolean generateStructuresInChunk(World par1World, Random par2Random, int par3, int par4)
    {
        ...
        int j = (par4 << 4) + 8;
        boolean flag = false;
        Iterator iterator = field_55220_e.values().iterator();
    ...
    public ChunkPosition getNearestInstance(World par1World, int par2, int par3, int par4)
    {
        ...
        Object obj = field_55220_e.values().iterator();
