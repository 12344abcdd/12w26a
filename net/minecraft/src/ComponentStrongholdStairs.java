...
public class ComponentStrongholdStairs extends ComponentStronghold
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        else
        {
            ...
            placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 0, 1, 6, 1, par3StructureBoundingBox);
            ...
            placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 0, 1, 5, 3, par3StructureBoundingBox);
            ...
            placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 0, 3, 4, 3, par3StructureBoundingBox);
            ...
            placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 0, 3, 3, 1, par3StructureBoundingBox);
            ...
            placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 0, 1, 2, 1, par3StructureBoundingBox);
            placeBlockAtCurrentPosition(par1World, Block.stoneBrick.blockID, 0, 1, 1, 2, par3StructureBoundingBox);
            placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 0, 1, 1, 3, par3StructureBoundingBox);
            return true;
        }
    }
}
