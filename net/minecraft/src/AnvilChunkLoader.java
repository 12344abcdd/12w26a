    ...
    public Chunk loadChunk(World par1World, int par2, int par3) throws IOException
    {
        ...
        synchronized (field_48450_c)
        {
            label0:
            {
                ...
                Iterator iterator = field_48451_a.iterator();
                ...
                while (!anvilchunkloaderpending.field_48427_a.equals(chunkcoordintpair));

                nbttagcompound = anvilchunkloaderpending.field_48426_b;
            }
        }
