...
public class WorldGenTrees extends WorldGenerator
{
    ...
    private final boolean field_56597_b;
        ...
        for (int k1 = (par4 - byte1) + i; k1 <= par4 + i; k1++)
        {
            ...
            for (int k4 = par3 - l3; k4 <= par3 + l3; k4++)
            {
                ...
                for (int k5 = par5 - l3; k5 <= par5 + l3; k5++)
                {
                    ...
                    {
                        setBlockAndMetadata(par1World, k4, k1, k5, Block.leaves.blockID, field_48199_d);
                    }
                }
            }
        }
            ...
            for (int i2 = (par4 - 3) + i; i2 <= par4 + i; i2++)
            {
                ...
                for (int l4 = par3 - i4; l4 <= par3 + i4; l4++)
                {
                    for (int j5 = par5 - i4; j5 <= par5 + i4; j5++)
                    {
                        ...
                        {
                            func_48198_a(par1World, l4 - 1, i2, j5, 8);
                        }

                        if (par2Random.nextInt(4) == 0 && par1World.getBlockId(l4 + 1, i2, j5) == 0)
                        {
                            func_48198_a(par1World, l4 + 1, i2, j5, 2);
                        }

                        if (par2Random.nextInt(4) == 0 && par1World.getBlockId(l4, i2, j5 - 1) == 0)
                        {
                            func_48198_a(par1World, l4, i2, j5 - 1, 1);
                        }

                        if (par2Random.nextInt(4) == 0 && par1World.getBlockId(l4, i2, j5 + 1) == 0)
                        {
                            func_48198_a(par1World, l4, i2, j5 + 1, 4);
                        }
                    }
                }
            }
                ...
                for (int j2 = 0; j2 < 2; j2++)
                {
                    for (int k3 = 0; k3 < 4; k3++)
                    {
                        if (par2Random.nextInt(4 - j2) == 0)
                        {
                            ...
                            setBlockAndMetadata(par1World, par3 + Direction.offsetX[Direction.footInvisibleFaceRemap[k3]], ((par4 + i) - 5) + j2, par5 + Direction.offsetZ[Direction.footInvisibleFaceRemap[k3]], Block.field_56780_bP.blockID, j4 << 2 | k3);
                        }
                    }
                }
            }
