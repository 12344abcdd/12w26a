...
public class ItemPickaxe extends ItemTool
{
    ...
    public boolean canHarvestBlock(Block par1Block)
    {
        ...
        if (par1Block == Block.field_56778_ax || par1Block == Block.field_56779_aw)
        {
    ...
    static
    {
        blocksEffectiveAgainst = (new Block[]
                {
                    Block.cobblestone, Block.field_55203_aj, Block.field_55202_ak, Block.stone, Block.sandStone, Block.cobblestoneMossy, Block.oreIron, Block.blockSteel, Block.oreCoal, Block.blockGold,
                    Block.oreGold, Block.field_56779_aw, Block.field_56778_ax, Block.ice, Block.netherrack, Block.oreLapis, Block.blockLapis, Block.oreRedstone, Block.oreRedstoneGlowing, Block.rail,
