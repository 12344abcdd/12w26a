...
public class GuiMainMenu extends GuiScreen
{
    ...
    private GuiButton field_55155_d;
    ...
    private static final String field_56481_h[] =
    {
    ...
    public void initGui()
    {
        ...
        if (mc.func_55063_q())
        {
            func_55153_b(i, 24, stringtranslate);
        }
        else
        {
            func_55154_a(i, 24, stringtranslate);
        }
    ...
    private void func_55154_a(int par1, int par2, StringTranslate par3StringTranslate)
    {
    ...
    private void func_55153_b(int par1, int par2, StringTranslate par3StringTranslate)
    {
        controlList.add(new GuiButton(11, width / 2 - 100, par1, par3StringTranslate.translateKey("menu.playdemo")));
        controlList.add(field_55155_d = new GuiButton(12, width / 2 - 100, par1 + par2 * 1, par3StringTranslate.translateKey("menu.resetdemo")));
        ISaveFormat isaveformat = mc.getSaveLoader();
        WorldInfo worldinfo = isaveformat.getWorldInfo("Demo_World");

        if (worldinfo == null)
        {
            field_55155_d.enabled = false;
        }
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            mc.func_58039_a("Demo_World", "Demo_World", DemoWorldServer.field_56874_a);
        }
        ...
        if (par1GuiButton.id == 12)
        {
            ...
            if (worldinfo != null)
            {
                GuiYesNo guiyesno = GuiSelectWorld.func_55139_a(this, worldinfo.getWorldName(), 12);
    ...
    private void drawPanorama(int par1, int par2, float par3)
    {
        ...
        for (int j = 0; j < i * i; j++)
        {
            ...
            for (int k = 0; k < 6; k++)
            {
                ...
                GL11.glBindTexture(GL11.GL_TEXTURE_2D, mc.renderEngine.getTexture(field_56481_h[k]));
