...
public class AnvilSaveConverter extends SaveFormatOld
{
    ...
    public List getSaveList()
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            long l = 0L;
            arraylist.add(new SaveFormatComparator(s, s1, worldinfo.getLastTimePlayed(), l, worldinfo.func_56915_q(), flag, worldinfo.isHardcoreModeEnabled(), worldinfo.func_55400_u()));
        }
    ...
    public boolean convertMapFormat(String par1Str, IProgressUpdate par2IProgressUpdate)
    {
        ...
        func_55214_a(file, arraylist);

        if (file1.exists())
        {
            func_55214_a(file1, arraylist1);
        }

        if (file2.exists())
        {
            func_55214_a(file2, arraylist2);
        }
        ...
        func_55213_a(new File(file, "region"), arraylist, ((WorldChunkManager)(obj)), 0, i, par2IProgressUpdate);
        func_55213_a(new File(file1, "region"), arraylist1, new WorldChunkManagerHell(BiomeGenBase.hell, 1.0F, 0.0F), arraylist.size(), i, par2IProgressUpdate);
        func_55213_a(new File(file2, "region"), arraylist2, new WorldChunkManagerHell(BiomeGenBase.sky, 0.5F, 0.0F), arraylist.size() + arraylist1.size(), i, par2IProgressUpdate);
    ...
    private void func_55213_a(File par1File, Iterable par2Iterable, WorldChunkManager par3WorldChunkManager, int par4, int par5, IProgressUpdate par6IProgressUpdate)
    {
        int i;
    ...
    private void func_55214_a(File par1File, Collection par2Collection)
    {
