...
public class MovingObjectPosition
{
    ...
    public MovingObjectPosition(int par1, int par2, int par3, int par4, Vec3 par5Vec3)
    {
        ...
        blockZ = par3;
        sideHit = par4;
        hitVec = Vec3.func_58128_a().func_58134_a(par5Vec3.xCoord, par5Vec3.yCoord, par5Vec3.zCoord);
    }
    ...
    public MovingObjectPosition(Entity par1Entity)
    {
        ...
        hitVec = Vec3.func_58128_a().func_58134_a(par1Entity.posX, par1Entity.posY, par1Entity.posZ);
    }
}
