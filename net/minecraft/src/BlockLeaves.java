...
public class BlockLeaves extends BlockLeavesBase
{
    ...
    public static final String field_56791_b[] =
    {
    ...
    {
        if (par1World.canLightningStrikeAt(par2, par3 + 1, par4) && !par1World.func_58081_i(par2, par3 - 1, par4) && par5Random.nextInt(15) == 1)
        {
