...
public class BlockPortal extends BlockBreakable
{
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (par1World.worldProvider.func_48217_e() && par5Random.nextInt(2000) < par1World.difficultySetting)
        {
            int i;

            for (i = par3; !par1World.func_58081_i(par2, i, par4) && i > 0; i--) { }

            if (i > 0 && !par1World.isBlockNormalCube(par2, i + 1, par4))
            {
                ItemMonsterPlacer.func_48440_a(par1World, 57, (double)par2 + 0.5D, (double)i + 1.1000000000000001D, (double)par4 + 0.5D);
            }
        }
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            par1World.func_56841_a((double)par2 + 0.5D, (double)par3 + 0.5D, (double)par4 + 0.5D, "portal.portal", 0.5F, par5Random.nextFloat() * 0.4F + 0.8F);
        }
    ...
    public int func_55201_e(World par1World, int par2, int par3, int i)
    {
        return 0;
    }
}
