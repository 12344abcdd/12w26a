...
public class EntityAIBreakDoor extends EntityAIDoorInteract
{
    ...
    public boolean continueExecuting()
    {
        ...
        return field_48329_i <= 240 && !targetDoor.func_48213_h(theEntity.worldObj, entityPosX, entityPosY, entityPosZ) && d < 4D;
    }
    ...
    {
        super.resetTask();
        theEntity.worldObj.func_56837_h(theEntity.entityId, entityPosX, entityPosY, entityPosZ, -1);
    }
    ...
    public void updateTask()
    {
        ...
        field_48329_i++;
        int i = (int)(((float)field_48329_i / 240F) * 10F);

        if (i != field_58080_j)
        {
            theEntity.worldObj.func_56837_h(theEntity.entityId, entityPosX, entityPosY, entityPosZ, i);
            field_58080_j = i;
        }

        if (field_48329_i == 240 && theEntity.worldObj.difficultySetting == 3)
        {
