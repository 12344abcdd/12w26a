...
public class ComponentScatteredFeatureDesertPyramid extends ComponentScatteredFeature
{
    ...
    {
        fillWithBlocks(par1World, par3StructureBoundingBox, 0, -4, 0, field_56607_a - 1, 0, field_56606_c - 1, Block.sandStone.blockID, Block.sandStone.blockID, false);

        for (int i = 1; i <= 9; i++)
        {
            fillWithBlocks(par1World, par3StructureBoundingBox, i, i, i, field_56607_a - 1 - i, i, field_56606_c - 1 - i, Block.sandStone.blockID, Block.sandStone.blockID, false);
            fillWithBlocks(par1World, par3StructureBoundingBox, i + 1, i, i + 1, field_56607_a - 2 - i, i, field_56606_c - 2 - i, 0, 0, false);
        }

        for (int j = 0; j < field_56607_a; j++)
        {
            for (int l = 0; l < field_56606_c; l++)
            {
                fillCurrentPositionBlocksDownwards(par1World, Block.sandStone.blockID, 0, j, -5, l, par3StructureBoundingBox);
            }
        }

        int k = getMetadataWithOffset(Block.field_56781_bQ.blockID, 3);
        int i1 = getMetadataWithOffset(Block.field_56781_bQ.blockID, 2);
        int j1 = getMetadataWithOffset(Block.field_56781_bQ.blockID, 0);
        int k1 = getMetadataWithOffset(Block.field_56781_bQ.blockID, 1);
        int l1 = 1;
        byte byte0 = 11;
        ...
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, k, 2, 10, 0, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, i1, 2, 10, 4, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, j1, 0, 10, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, k1, 4, 10, 2, par3StructureBoundingBox);
        fillWithBlocks(par1World, par3StructureBoundingBox, field_56607_a - 5, 0, 0, field_56607_a - 1, 9, 4, Block.sandStone.blockID, 0, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, field_56607_a - 4, 10, 1, field_56607_a - 2, 10, 3, Block.sandStone.blockID, Block.sandStone.blockID, false);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, k, field_56607_a - 3, 10, 0, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, i1, field_56607_a - 3, 10, 4, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, j1, field_56607_a - 5, 10, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, k1, field_56607_a - 1, 10, 2, par3StructureBoundingBox);
        ...
        fillWithBlocks(par1World, par3StructureBoundingBox, 5, 4, 5, field_56607_a - 6, 4, field_56606_c - 6, Block.sandStone.blockID, Block.sandStone.blockID, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, 9, 4, 9, 11, 4, 11, 0, 0, false);
        func_56602_a(par1World, par3StructureBoundingBox, 8, 1, 8, 8, 3, 8, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        func_56602_a(par1World, par3StructureBoundingBox, 12, 1, 8, 12, 3, 8, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        func_56602_a(par1World, par3StructureBoundingBox, 8, 1, 12, 8, 3, 12, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        func_56602_a(par1World, par3StructureBoundingBox, 12, 1, 12, 12, 3, 12, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, 1, 1, 5, 4, 4, 11, Block.sandStone.blockID, Block.sandStone.blockID, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, field_56607_a - 5, 1, 5, field_56607_a - 2, 4, 11, Block.sandStone.blockID, Block.sandStone.blockID, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, 6, 7, 9, 6, 7, 11, Block.sandStone.blockID, Block.sandStone.blockID, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, field_56607_a - 7, 7, 9, field_56607_a - 7, 7, 11, Block.sandStone.blockID, Block.sandStone.blockID, false);
        func_56602_a(par1World, par3StructureBoundingBox, 5, 5, 9, 5, 7, 11, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        func_56602_a(par1World, par3StructureBoundingBox, field_56607_a - 6, 5, 9, field_56607_a - 6, 7, 11, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        ...
        placeBlockAtCurrentPosition(par1World, 0, 0, field_56607_a - 6, 5, 10, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 0, 0, field_56607_a - 6, 6, 10, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 0, 0, field_56607_a - 7, 6, 10, par3StructureBoundingBox);
        fillWithBlocks(par1World, par3StructureBoundingBox, 2, 4, 4, 2, 6, 4, 0, 0, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, field_56607_a - 3, 4, 4, field_56607_a - 3, 6, 4, 0, 0, false);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, k, 2, 4, 5, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, k, 2, 3, 4, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, k, field_56607_a - 3, 4, 5, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, k, field_56607_a - 3, 3, 4, par3StructureBoundingBox);
        fillWithBlocks(par1World, par3StructureBoundingBox, 1, 1, 3, 2, 2, 3, Block.sandStone.blockID, Block.sandStone.blockID, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, field_56607_a - 3, 1, 3, field_56607_a - 2, 2, 3, Block.sandStone.blockID, Block.sandStone.blockID, false);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, 0, 1, 1, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, 0, field_56607_a - 2, 1, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 1, 1, 2, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 1, field_56607_a - 2, 2, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, k1, 2, 1, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_56781_bQ.blockID, j1, field_56607_a - 3, 1, 2, par3StructureBoundingBox);
        fillWithBlocks(par1World, par3StructureBoundingBox, 4, 3, 5, 4, 3, 18, Block.sandStone.blockID, Block.sandStone.blockID, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, field_56607_a - 5, 3, 5, field_56607_a - 5, 3, 17, Block.sandStone.blockID, Block.sandStone.blockID, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, 3, 1, 5, 4, 2, 16, 0, 0, false);
        fillWithBlocks(par1World, par3StructureBoundingBox, field_56607_a - 6, 1, 5, field_56607_a - 5, 2, 16, 0, 0, false);
        ...
        for (int i2 = 5; i2 <= 17; i2 += 2)
        {
            ...
            placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, field_56607_a - 5, 1, i2, par3StructureBoundingBox);
            placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 1, field_56607_a - 5, 2, i2, par3StructureBoundingBox);
        }
        ...
        for (int j2 = 0; j2 <= field_56607_a - 1; j2 += field_56607_a - 1)
        {
        ...
        for (int k2 = 2; k2 <= field_56607_a - 3; k2 += field_56607_a - 3 - 2)
        {
        ...
        func_56602_a(par1World, par3StructureBoundingBox, 8, 4, 0, 12, 6, 0, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        ...
        func_56602_a(par1World, par3StructureBoundingBox, 8, -14, 8, 12, -11, 12, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        func_56602_a(par1World, par3StructureBoundingBox, 8, -10, 8, 12, -10, 12, Block.sandStone.blockID, 1, Block.sandStone.blockID, 1, false);
        func_56602_a(par1World, par3StructureBoundingBox, 8, -9, 8, 12, -9, 12, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        ...
        for (int l2 = 0; l2 < 4; l2++)
        {
            if (!field_56616_e[l2])
            {
                ...
                field_56616_e[l2] = func_56600_a(par1World, par3StructureBoundingBox, par2Random, 10 + i3, -11, 10 + j3, field_56615_f, 2 + par2Random.nextInt(5));
            }
        }
    ...
    static
    {
        field_56615_f = (new WeightedRandomChestContent[]
                {
