...
public class EntityAIMoveThroughVillage extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        Vec3 vec3 = RandomPositionGenerator.func_48620_a(theEntity, 10, 7, Vec3.func_58128_a().func_58134_a(doorInfo.posX, doorInfo.posY, doorInfo.posZ));
        ...
        {
            theEntity.getNavigator().setBreakDoors(false);
            field_48291_c = theEntity.getNavigator().getPathToXYZ(vec3.xCoord, vec3.yCoord, vec3.zCoord);
            theEntity.getNavigator().setBreakDoors(flag);
