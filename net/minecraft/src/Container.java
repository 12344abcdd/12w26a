...
public abstract class Container
{
    ...
    protected Slot func_55197_a(Slot par1Slot)
    {
    ...
    public void func_56981_a(ICrafting par1ICrafting)
    {
        ...
        else
        {
            ...
            par1ICrafting.func_56245_a(this, func_56980_a());
            updateCraftingResults();
            return;
        }
    }

    public List func_56980_a()
    {
    ...
    public Slot func_56978_a(IInventory par1IInventory, int par2)
    {
        for (Iterator iterator = inventorySlots.iterator(); iterator.hasNext();)
        {
            Slot slot = (Slot)iterator.next();

            if (slot.func_57189_a(par1IInventory, par2))
            {
                return slot;
            }
        }
    ...
    public boolean func_56979_c(EntityPlayer par1EntityPlayer)
    {
        return !field_20918_b.contains(par1EntityPlayer);
    }

    public void func_56982_a(EntityPlayer par1EntityPlayer, boolean par2)
    {
        if (par2)
        {
            field_20918_b.remove(par1EntityPlayer);
        }
        else
        {
            field_20918_b.add(par1EntityPlayer);
        }
    }
