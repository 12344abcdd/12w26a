...
public class VillageSiege
{
    ...
    private boolean func_48574_b()
    {
        ...
        for (Iterator iterator = list.iterator(); iterator.hasNext();)
        {
            ...
            if (field_48576_f != null && field_48576_f.getNumVillageDoors() >= 10 && field_48576_f.getTicksSinceLastDoorAdding() >= 20 && field_48576_f.getNumVillagers() >= 20)
            {
                ...
                Vec3 vec3 = func_48572_a(field_48577_g, field_48583_h, field_48584_i);
    ...
    private boolean func_48575_c()
    {
        ...
        entityzombie.setLocationAndAngles(vec3.xCoord, vec3.yCoord, vec3.zCoord, field_48582_a.rand.nextFloat() * 360F, 0.0F);
    ...
    private Vec3 func_48572_a(int par1, int par2, int par3)
    {
        for (int i = 0; i < 10; i++)
        {
