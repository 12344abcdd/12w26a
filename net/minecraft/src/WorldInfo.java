...
public class WorldInfo
{
    ...
    private EnumGameType field_56917_q;
    ...
    private boolean field_55401_t;
    private boolean field_56916_u;
    ...
    public WorldInfo(NBTTagCompound par1NBTTagCompound)
    {
        ...
        field_56917_q = EnumGameType.func_57536_a(par1NBTTagCompound.getInteger("GameType"));
        ...
        {
            field_56916_u = par1NBTTagCompound.getBoolean("initialized");
        }
        else
        {
            field_56916_u = true;
        ...
        {
            field_55401_t = par1NBTTagCompound.getBoolean("allowCommands");
        }
        else
        {
            field_55401_t = field_56917_q == EnumGameType.CREATIVE;
        }
    ...
    public WorldInfo(WorldSettings par1WorldSettings, String par2Str)
    {
        ...
        field_56917_q = par1WorldSettings.func_57458_e();
        ...
        field_55401_t = par1WorldSettings.func_55249_i();
        field_56916_u = false;
    }
    ...
    public WorldInfo(WorldInfo par1WorldInfo)
    {
        ...
        field_56917_q = par1WorldInfo.field_56917_q;
        ...
        field_55401_t = par1WorldInfo.field_55401_t;
        field_56916_u = par1WorldInfo.field_56916_u;
    }
    ...
    private void updateTagCompound(NBTTagCompound par1NBTTagCompound, NBTTagCompound par2NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setInteger("GameType", field_56917_q.func_57538_a());
        ...
        par1NBTTagCompound.setBoolean("allowCommands", field_55401_t);
        par1NBTTagCompound.setBoolean("initialized", field_56916_u);
    ...
    public void func_56911_a(EnumGameType par1EnumGameType)
    {
        field_56917_q = par1EnumGameType;
    }
    ...
    {
        return field_55401_t;
    }

    public boolean func_56914_v()
    {
        return field_56916_u;
    }

    public void func_56913_c(boolean par1)
    {
        field_56916_u = par1;
    }
}
