...
public abstract class GuiContainer extends GuiScreen
{
    ...
    {
        super.initGui();
        mc.field_56455_h.craftingInventory = inventorySlots;
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (inventoryplayer.getItemStack() == null && slot != null && slot.getHasStack())
        {
            ...
            func_56482_a(itemstack, par1 - i, par2 - j);
        }
    ...
    protected void func_56483_a(String par1Str, int par2, int par3)
    {
        GL11.glDisable(GL12.GL_RESCALE_NORMAL);
        RenderHelper.disableStandardItemLighting();
        GL11.glDisable(GL11.GL_LIGHTING);
    ...
    {
        return func_56484_a(par1Slot.xDisplayPosition, par1Slot.yDisplayPosition, 16, 16, par2, par3);
    }
    ...
    protected void handleMouseClick(Slot par1Slot, int par2, int par3, boolean par4)
    {
        ...
        mc.field_56453_c.windowClick(inventorySlots.windowId, par2, par3, par4, mc.field_56455_h);
    }
    ...
    public void onGuiClosed()
    {
        ...
        {
            inventorySlots.onCraftGuiClosed(mc.field_56455_h);
            return;
        }
    }
    ...
    public void updateScreen()
    {
        ...
        if (!mc.field_56455_h.isEntityAlive() || mc.field_56455_h.isDead)
        {
            mc.field_56455_h.closeScreen();
        }
    }
