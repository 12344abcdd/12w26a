...
abstract class ComponentVillage extends StructureComponent
{
    ...
    protected ComponentVillageStartPiece field_56619_k;

    protected ComponentVillage(ComponentVillageStartPiece par1ComponentVillageStartPiece, int par2)
    {
        super(par2);
        field_56619_k = par1ComponentVillageStartPiece;
    }
    ...
    protected int func_56617_d(int par1, int par2)
    {
        if (field_56619_k.field_56630_b)
        {
            ...
            {
                return Block.field_56781_bQ.blockID;
            }
    ...
    protected int func_56618_e(int par1, int par2)
    {
        if (field_56619_k.field_56630_b)
        {
            if (par1 == Block.wood.blockID)
    ...
    {
        int i = func_56617_d(par2, par3);
        int j = func_56618_e(par2, par3);
    ...
    {
        int i = func_56617_d(par9, 0);
        int j = func_56618_e(par9, 0);
        int k = func_56617_d(par10, 0);
        int l = func_56618_e(par10, 0);
        super.func_56602_a(par1World, par2StructureBoundingBox, par3, par4, par5, par6, par7, par8, i, j, k, l, par11);
    }
