...
{
    private static final DateFormat field_57408_a = new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss");
    private static IntBuffer field_57406_b;
    private static int field_57407_c[];
    ...
    public static String func_35879_a(File par0File, String par1Str, int par2, int par3)
    {
        try
        {
            ...
            if (field_57406_b == null || field_57406_b.capacity() < i)
            {
                field_57406_b = BufferUtils.createIntBuffer(i);
                field_57407_c = new int[i];
            }

            GL11.glPixelStorei(GL11.GL_PACK_ALIGNMENT, 1);
            GL11.glPixelStorei(GL11.GL_UNPACK_ALIGNMENT, 1);
            field_57406_b.clear();
            GL11.glReadPixels(0, 0, par2, par3, GL12.GL_BGRA, GL12.GL_UNSIGNED_INT_8_8_8_8_REV, field_57406_b);
            field_57406_b.get(field_57407_c);
            func_57404_a(field_57407_c, par2, par3);
            BufferedImage bufferedimage = new BufferedImage(par2, par3, 1);
            bufferedimage.setRGB(0, 0, par2, par3, field_57407_c, 0, par2);
            File file1;

            if (par1Str == null)
            {
                file1 = func_57405_a(file);
            }
            else
            {
    ...
    private static File func_57405_a(File par0File)
    {
        String s = field_57408_a.format(new Date()).toString();
        int i = 1;
    ...
    private static void func_57404_a(int par0ArrayOfInteger[], int par1, int par2)
    {
        int ai[] = new int[par1];
        int i = par2 / 2;
