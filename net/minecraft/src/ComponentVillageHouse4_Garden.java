...
public class ComponentVillageHouse4_Garden extends ComponentVillage
{
    ...
    public static ComponentVillageHouse4_Garden func_56622_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
