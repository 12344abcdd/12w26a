...
public class RenderBlocks
{
    ...
    public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4)
    {
        ...
        if (i == 29)
        {
            return func_57334_f(par1Block, par2, par3, par4);
        }

        if (i == 30)
        {
            return func_57336_g(par1Block, par2, par3, par4);
        }
        ...
        if (i == 28)
        {
            return func_57333_a((BlockCocoa)par1Block, par2, par3, par4);
        }
        else
        {
            return false;
    ...
    public boolean renderBlockLever(Block par1Block, int par2, int par3, int par4)
    {
        ...
        float f9 = 0.0625F;
        float f10 = 0.625F;
        avec3[0] = Vec3.func_58128_a().func_58134_a(-f8, 0.0D, -f9);
        avec3[1] = Vec3.func_58128_a().func_58134_a(f8, 0.0D, -f9);
        avec3[2] = Vec3.func_58128_a().func_58134_a(f8, 0.0D, f9);
        avec3[3] = Vec3.func_58128_a().func_58134_a(-f8, 0.0D, f9);
        avec3[4] = Vec3.func_58128_a().func_58134_a(-f8, f10, -f9);
        avec3[5] = Vec3.func_58128_a().func_58134_a(f8, f10, -f9);
        avec3[6] = Vec3.func_58128_a().func_58134_a(f8, f10, f9);
        avec3[7] = Vec3.func_58128_a().func_58134_a(-f8, f10, f9);
        ...
        for (int j1 = 0; j1 < 8; j1++)
        {
            ...
            if (j == 0 || j == 7)
            {
                avec3[j1].func_57183_c((float)Math.PI);
            }
    ...
    public boolean func_57334_f(Block par1Block, int par2, int par3, int par4)
    {
        Tessellator tessellator = Tessellator.instance;
        int i = blockAccess.getBlockMetadata(par2, par3, par4);
        int j = i & 3;
        boolean flag = (i & 4) == 4;
        boolean flag1 = (i & 8) == 8;
        boolean flag2 = !blockAccess.func_58081_i(par2, par3 - 1, par4);
        ...
        float f12 = 0.046875F;
        float f13 = 0.3125F;
        avec3[0] = Vec3.func_58128_a().func_58134_a(-f11, 0.0D, -f12);
        avec3[1] = Vec3.func_58128_a().func_58134_a(f11, 0.0D, -f12);
        avec3[2] = Vec3.func_58128_a().func_58134_a(f11, 0.0D, f12);
        avec3[3] = Vec3.func_58128_a().func_58134_a(-f11, 0.0D, f12);
        avec3[4] = Vec3.func_58128_a().func_58134_a(-f11, f13, -f12);
        avec3[5] = Vec3.func_58128_a().func_58134_a(f11, f13, -f12);
        avec3[6] = Vec3.func_58128_a().func_58134_a(f11, f13, f12);
        avec3[7] = Vec3.func_58128_a().func_58134_a(-f11, f13, f12);
        ...
        float f15 = 0.09375F;
        float f16 = 0.03125F;
        avec3[0] = Vec3.func_58128_a().func_58134_a(-f14, 0.0D, -f15);
        avec3[1] = Vec3.func_58128_a().func_58134_a(f14, 0.0D, -f15);
        avec3[2] = Vec3.func_58128_a().func_58134_a(f14, 0.0D, f15);
        avec3[3] = Vec3.func_58128_a().func_58134_a(-f14, 0.0D, f15);
        avec3[4] = Vec3.func_58128_a().func_58134_a(-f14, f16, -f15);
        avec3[5] = Vec3.func_58128_a().func_58134_a(f14, f16, -f15);
        avec3[6] = Vec3.func_58128_a().func_58134_a(f14, f16, f15);
        avec3[7] = Vec3.func_58128_a().func_58134_a(-f14, f16, f15);
        ...
        if (flag)
        {
            ...
            float f19 = f18 + f17;
            int j2 = (Block.field_56775_bU.blockIndexInTexture & 0xf) << 4;
            int k2 = Block.field_56775_bU.blockIndexInTexture & 0xf0;
    ...
    public boolean func_57336_g(Block par1Block, int par2, int par3, int par4)
    {
        Tessellator tessellator = Tessellator.instance;
        ...
        boolean flag2 = BlockTripWire.func_56788_a(blockAccess, par2, par3, par4, j, 1);
        boolean flag3 = BlockTripWire.func_56788_a(blockAccess, par2, par3, par4, j, 3);
        boolean flag4 = BlockTripWire.func_56788_a(blockAccess, par2, par3, par4, j, 2);
        boolean flag5 = BlockTripWire.func_56788_a(blockAccess, par2, par3, par4, j, 0);
        float f1 = 0.03125F;
    ...
    public void func_57335_a(Block par1Block, World par2World, int par3, int par4, int par5, int par6)
    {
        float f = 0.5F;
        float f1 = 1.0F;
        float f2 = 0.8F;
    ...
    private boolean func_57333_a(BlockCocoa par1BlockCocoa, int par2, int par3, int par4)
    {
        Tessellator tessellator = Tessellator.instance;
