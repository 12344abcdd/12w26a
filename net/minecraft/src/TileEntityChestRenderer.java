...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityChestAt(TileEntityChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        ...
        if (!par1TileEntityChest.func_56201_k())
        {
            i = 0;
        }
        else
        {
            ...
            if (block != null && i == 0)
            {
                ((BlockChest)block).unifyAdjacentChests(par1TileEntityChest.func_56200_j(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                i = par1TileEntityChest.getBlockMetadata();
            }
