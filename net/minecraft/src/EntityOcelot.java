...
public class EntityOcelot extends EntityTameable
{
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (aiTempt.func_48270_h() && itemstack != null && itemstack.itemID == Item.fishRaw.shiftedIndex && par1EntityPlayer.getDistanceSqToEntity(this) < 9D)
        {
