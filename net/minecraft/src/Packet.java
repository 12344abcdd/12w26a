...
public abstract class Packet
{
    ...
    public static void func_55156_a(DataOutputStream par0DataOutputStream, byte par1ArrayOfByte[]) throws IOException
    {
        par0DataOutputStream.writeShort(par1ArrayOfByte.length);
        par0DataOutputStream.write(par1ArrayOfByte);
    }

    public static byte[] func_55157_b(DataInputStream par0DataInputStream) throws IOException
    {
