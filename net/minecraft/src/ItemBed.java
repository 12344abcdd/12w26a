...
public class ItemBed extends Item
{
    ...
    {
        super(par1);
        func_56813_a(CreativeTabs.field_57051_c);
    }
    ...
    public boolean func_56812_a(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        if (par3World.isAirBlock(par4, par5, par6) && par3World.isAirBlock(par4 + byte0, par5, par6 + byte1) && par3World.func_58081_i(par4, par5 - 1, par6) && par3World.func_58081_i(par4 + byte0, par5 - 1, par6 + byte1))
        {
