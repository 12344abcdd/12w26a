...
public final class ItemStack
{
    ...
    public boolean func_56991_a(EntityPlayer par1EntityPlayer, World par2World, int par3, int par4, int par5, int par6, float par7, float par8, float par9)
    {
        boolean flag = getItem().func_56812_a(this, par1EntityPlayer, par2World, par3, par4, par5, par6, par7, par8, par9);
    ...
    public void func_58115_a(World par1World, int par2, int par3, int par4, int par5, EntityPlayer par6EntityPlayer)
    {
        boolean flag = Item.itemsList[itemID].func_58078_a(this, par1World, par2, par3, par4, par5, par6EntityPlayer);
    ...
    public boolean func_56992_a(EntityLiving par1EntityLiving)
    {
        return Item.itemsList[itemID].func_56815_a(this, par1EntityLiving);
    }
    ...
    public void func_55397_a(String par1Str, NBTBase par2NBTBase)
    {
        if (stackTagCompound == null)
        {
            setTagCompound(new NBTTagCompound());
