...
public class TextureCompassFX extends TextureFX
{
    ...
    public void onTick()
    {
        ...
        if (mc.field_56452_f != null && mc.field_56455_h != null)
        {
            ChunkCoordinates chunkcoordinates = mc.field_56452_f.getSpawnPoint();
            double d2 = (double)chunkcoordinates.posX - mc.field_56455_h.posX;
            double d4 = (double)chunkcoordinates.posZ - mc.field_56455_h.posZ;
            d = ((double)(mc.field_56455_h.rotationYaw - 90F) * Math.PI) / 180D - Math.atan2(d4, d2);
