...
public class ChunkProviderGenerate implements IChunkProvider
{
    ...
    private MapGenScatteredFeature field_56897_x;
    ...
    public ChunkProviderGenerate(World par1World, long par2, boolean par4)
    {
        ...
        field_56897_x = new MapGenScatteredFeature();
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        if (mapFeaturesEnabled)
        {
            ...
            field_56897_x.generate(this, worldObj, par1, par2, abyte0);
        }
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        if (mapFeaturesEnabled)
        {
            ...
            field_56897_x.generateStructuresInChunk(worldObj, rand, par2, par3);
        }
