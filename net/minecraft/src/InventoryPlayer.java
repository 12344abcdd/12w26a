...
public class InventoryPlayer implements IInventory
{
    ...
    private ItemStack field_56199_f;
    ...
    public static int func_56198_h()
    {
        return 9;
    }
    ...
    public void func_52006_a(Item par1Item, int par2)
    {
        if (par1Item != null)
        {
            ...
            if (field_56199_f != null && field_56199_f.isItemEnchantable() && getInventorySlotContainItemAndDamage(field_56199_f.itemID, field_56199_f.getItemDamageForDisplay()) == currentItem)
            {
                return;
            }
