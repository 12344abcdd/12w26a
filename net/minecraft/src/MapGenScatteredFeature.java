...
{
    private static List field_56925_a;
    ...
    protected boolean canSpawnStructureAtCoords(int par1, int par2)
    {
        ...
        if (par1 == k && par2 == l)
        {
            boolean flag = worldObj.getWorldChunkManager().areBiomesViable(par1 * 16 + 8, par2 * 16 + 8, 0, field_56925_a);
    ...
    static
    {
        field_56925_a = Arrays.asList(new BiomeGenBase[]
                {
