...
public class ItemMap extends ItemMapBase
{
    protected ItemMap(int par1)
    {
        super(par1);
        setMaxStackSize(1);
        func_56813_a(CreativeTabs.field_57046_f);
    }
    ...
    public Packet func_56827_d(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        byte abyte0[] = getMapData(par1ItemStack, par2World).func_56989_a(par1ItemStack, par2World, par3EntityPlayer);
