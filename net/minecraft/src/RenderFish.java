...
public class RenderFish extends Render
{
    ...
    public void doRenderFishHook(EntityFishHook par1EntityFishHook, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (par1EntityFishHook.angler != null)
        {
            ...
            Vec3 vec3 = Vec3.func_58128_a().func_58134_a(-0.5D, 0.029999999999999999D, 0.80000000000000004D);
            ...
            double d4 = par1EntityFishHook.angler.prevPosX + (par1EntityFishHook.angler.posX - par1EntityFishHook.angler.prevPosX) * (double)par9 + vec3.xCoord;
            double d5 = par1EntityFishHook.angler.prevPosY + (par1EntityFishHook.angler.posY - par1EntityFishHook.angler.prevPosY) * (double)par9 + vec3.yCoord;
            double d6 = par1EntityFishHook.angler.prevPosZ + (par1EntityFishHook.angler.posZ - par1EntityFishHook.angler.prevPosZ) * (double)par9 + vec3.zCoord;
