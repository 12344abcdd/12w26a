...
public class Packet51MapChunk extends Packet
{
    ...
    public Packet51MapChunk(Chunk par1Chunk, boolean par2, int par3)
    {
        ...
        for (int j1 = 0; j1 < aextendedblockstorage.length; j1++)
        {
            ...
            {
                byte abyte2[] = aextendedblockstorage[j1].func_48692_g();
        ...
        for (int k1 = 0; k1 < aextendedblockstorage.length; k1++)
        {
            ...
            {
                NibbleArray nibblearray = aextendedblockstorage[k1].func_48697_j();
        ...
        try
        {
            field_56568_g = (byte[])abyte0.clone();
    ...
    public void readPacketData(DataInputStream par1DataInputStream) throws IOException
    {
        ...
        field_56568_g = new byte[k];
        Inflater inflater = new Inflater();
        inflater.setInput(temp, 0, tempLength);

        try
        {
            inflater.inflate(field_56568_g);
        }
    ...
    public byte[] func_56567_b()
    {
        return field_56568_g;
    }
}
