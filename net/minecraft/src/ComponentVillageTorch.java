...
public class ComponentVillageTorch extends ComponentVillage
{
    ...
    public static StructureBoundingBox func_56624_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6)
    {
