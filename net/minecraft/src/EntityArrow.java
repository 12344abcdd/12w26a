...
public class EntityArrow extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if (i > 0)
        {
            ...
            if (axisalignedbb != null && axisalignedbb.isVecInside(Vec3.func_58128_a().func_58134_a(posX, posY, posZ)))
            {
                inGround = true;
            }
        }
        ...
        ticksInAir++;
        Vec3 vec3 = Vec3.func_58128_a().func_58134_a(posX, posY, posZ);
        Vec3 vec3_1 = Vec3.func_58128_a().func_58134_a(posX + motionX, posY + motionY, posZ + motionZ);
        MovingObjectPosition movingobjectposition = worldObj.rayTraceBlocks_do_do(vec3, vec3_1, false, true);
        vec3 = Vec3.func_58128_a().func_58134_a(posX, posY, posZ);
        vec3_1 = Vec3.func_58128_a().func_58134_a(posX + motionX, posY + motionY, posZ + motionZ);

        if (movingobjectposition != null)
        {
            vec3_1 = Vec3.func_58128_a().func_58134_a(movingobjectposition.hitVec.xCoord, movingobjectposition.hitVec.yCoord, movingobjectposition.hitVec.zCoord);
        }
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setByte("pickup", (byte)field_58017_a);
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            field_58017_a = par1NBTTagCompound.getByte("pickup");
        }
        else if (par1NBTTagCompound.hasKey("player"))
        {
            field_58017_a = par1NBTTagCompound.getBoolean("player") ? 1 : 0;
        }
    }
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        ...
        boolean flag = field_58017_a == 1 || field_58017_a == 2 && par1EntityPlayer.capabilities.isCreativeMode;

        if (field_58017_a == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1)))
        {
            flag = false;
        }
    ...
    public void func_56187_a(boolean par1)
    {
