...
public class Block
{
    private CreativeTabs field_56774_a;
    ...
    public static final BlockHalfSlab field_55203_aj;
    public static final BlockHalfSlab field_55202_ak;
    ...
    public static final Block field_56779_aw;
    public static final Block field_56778_ax;
    ...
    public static final BlockHalfSlab field_55204_bN;
    public static final BlockHalfSlab field_55205_bO;
    public static final Block field_56780_bP;
    public static final Block field_56781_bQ;
    public static final Block oreDiamond;
    public static final Block field_56777_bS;
    public static final BlockTripWireSource field_56776_bT;
    public static final Block field_56775_bU;
    public static final Block blockDiamond;
    public static final Block field_58076_bW;
    public static final Block field_58075_bX;
    public static final Block field_58074_bY;
    ...
    public float func_58072_i(World par1World, int par2, int par3, int par4)
    {
    ...
    {
        return AxisAlignedBB.func_58144_a().func_58153_a((double)par2 + minX, (double)par3 + minY, (double)par4 + minZ, (double)par2 + maxX, (double)par3 + maxY, (double)par4 + maxZ);
    }

    public void func_56763_a(World par1World, int par2, int par3, int par4, AxisAlignedBB par5AxisAlignedBB, List par6List, Entity par7Entity)
    {
    ...
    public void func_56762_a(World world, int i, int j, int k, int l, int i1)
    {
    }
    ...
    public float func_58073_a(EntityPlayer par1EntityPlayer, World par2World, int par3, int par4, int par5)
    {
        float f = func_58072_i(par2World, par3, par4, par5);
    ...
    protected void func_56766_f(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            while (par5 > 0)
    ...
    public boolean func_56764_a(World par1World, int par2, int par3, int i, EntityPlayer entityplayer, int j, float f, float f1, float f2)
    {
        return false;
    }
    ...
    public void func_56765_a(World world, int i, int j, int k, int l, float f, float f1, float f2)
    {
    }
    ...
    public int func_55201_e(World par1World, int par2, int par3, int par4)
    {
        return blockID;
    }

    public int func_55199_h(World par1World, int par2, int par3, int par4)
    {
        return damageDropped(par1World.getBlockMetadata(par2, par3, par4));
    }

    public void func_56771_a(int par1, CreativeTabs par2CreativeTabs, List par3List)
    {
        par3List.add(new ItemStack(par1, 1, 0));
    }

    public CreativeTabs func_56769_v()
    {
        return field_56774_a;
    }

    public Block func_56773_a(CreativeTabs par1CreativeTabs)
    {
        field_56774_a = par1CreativeTabs;
        return this;
    }

    public void func_56767_a(World world, int i, int j, int k, int l, EntityPlayer entityplayer)
    {
    }

    public void func_56770_g(World world, int i, int j, int k, int l)
    {
    }

    public void func_56772_i(World world, int i, int j, int k)
    {
    }

    public void func_56768_a(World world, long l, long l1)
    {
    }
    ...
    static
    {
        ...
        cobblestone = (new Block(4, 16, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stonebrick").func_56773_a(CreativeTabs.field_57050_b);
        ...
        bedrock = (new Block(7, 17, Material.rock)).setBlockUnbreakable().setResistance(6000000F).setStepSound(soundStoneFootstep).setBlockName("bedrock").disableStats().func_56773_a(CreativeTabs.field_57050_b);
        ...
        blockLapis = (new Block(22, 144, Material.rock)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("blockLapis").func_56773_a(CreativeTabs.field_57050_b);
        ...
        field_55203_aj = (BlockHalfSlab)(new BlockStep(43, true)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
        field_55202_ak = (BlockHalfSlab)(new BlockStep(44, false)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneSlab");
        brick = (new Block(45, 7, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("brick").func_56773_a(CreativeTabs.field_57050_b);
        ...
        cobblestoneMossy = (new Block(48, 36, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("stoneMoss").func_56773_a(CreativeTabs.field_57050_b);
        ...
        field_56779_aw = (new BlockOre(56, 50)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("oreDiamond");
        field_56778_ax = (new BlockOreStorage(57, 24)).setHardness(5F).setResistance(10F).setStepSound(soundMetalFootstep).setBlockName("blockDiamond");
        ...
        stoneOvenIdle = (new BlockFurnace(61, false)).setHardness(3.5F).setStepSound(soundStoneFootstep).setBlockName("furnace").setRequiresSelfNotify().func_56773_a(CreativeTabs.field_57051_c);
        ...
        oreRedstone = (new BlockRedstoneOre(73, 51, false)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("oreRedstone").setRequiresSelfNotify().func_56773_a(CreativeTabs.field_57050_b);
        ...
        torchRedstoneActive = (new BlockRedstoneTorch(76, 99, true)).setHardness(0.0F).setLightValue(0.5F).setStepSound(soundWoodFootstep).setBlockName("notGate").setRequiresSelfNotify().func_56773_a(CreativeTabs.field_57048_d);
        ...
        netherBrick = (new Block(112, 224, Material.rock)).setHardness(2.0F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("netherBrick").func_56773_a(CreativeTabs.field_57050_b);
        ...
        endPortalFrame = (new BlockEndPortalFrame(120)).setStepSound(soundGlassFootstep).setLightValue(0.125F).setHardness(-1F).setBlockName("endPortalFrame").setRequiresSelfNotify().setResistance(6000000F).func_56773_a(CreativeTabs.field_57051_c);
        whiteStone = (new Block(121, 175, Material.rock)).setHardness(3F).setResistance(15F).setStepSound(soundStoneFootstep).setBlockName("whiteStone").func_56773_a(CreativeTabs.field_57050_b);
        ...
        redstoneLampIdle = (new BlockRedstoneLight(123, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("redstoneLight").func_56773_a(CreativeTabs.field_57048_d);
        ...
        field_55204_bN = (BlockHalfSlab)(new BlockWoodSlab(125, true)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("woodSlab");
        field_55205_bO = (BlockHalfSlab)(new BlockWoodSlab(126, false)).setHardness(2.0F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("woodSlab");
        field_56780_bP = (new BlockCocoa(127)).setHardness(0.2F).setResistance(5F).setStepSound(soundWoodFootstep).setBlockName("cocoa").setRequiresSelfNotify();
        field_56781_bQ = (new BlockStairs(128, sandStone, 0)).setBlockName("stairsSandStone").setRequiresSelfNotify();
        oreDiamond = (new BlockOre(129, 171)).setHardness(3F).setResistance(5F).setStepSound(soundStoneFootstep).setBlockName("oreEmerald");
        field_56777_bS = (new BlockEnderChest(130)).setHardness(22.5F).setResistance(1000F).setStepSound(soundStoneFootstep).setBlockName("enderChest").setRequiresSelfNotify().setLightValue(0.5F);
        field_56776_bT = (BlockTripWireSource)(new BlockTripWireSource(131)).setBlockName("tripWireSource").setRequiresSelfNotify();
        field_56775_bU = (new BlockTripWire(132)).setBlockName("tripWire").setRequiresSelfNotify();
        ...
        field_58076_bW = (new BlockStairs(134, planks, 1)).setBlockName("stairsWoodSpruce").setRequiresSelfNotify();
        field_58075_bX = (new BlockStairs(135, planks, 2)).setBlockName("stairsWoodBirch").setRequiresSelfNotify();
        field_58074_bY = (new BlockStairs(136, planks, 3)).setBlockName("stairsWoodJungle").setRequiresSelfNotify();
        ...
        Item.itemsList[field_55202_ak.blockID] = (new ItemSlab(field_55202_ak.blockID - 256, field_55202_ak, field_55203_aj, false)).setItemName("stoneSlab");
        Item.itemsList[field_55203_aj.blockID] = (new ItemSlab(field_55203_aj.blockID - 256, field_55202_ak, field_55203_aj, true)).setItemName("stoneSlab");
        Item.itemsList[field_55205_bO.blockID] = (new ItemSlab(field_55205_bO.blockID - 256, field_55205_bO, field_55204_bN, false)).setItemName("woodSlab");
        Item.itemsList[field_55204_bN.blockID] = (new ItemSlab(field_55204_bN.blockID - 256, field_55205_bO, field_55204_bN, true)).setItemName("woodSlab");
