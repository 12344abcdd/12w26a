...
public class BlockRedstoneTorch extends BlockTorch
{
    ...
    private static Map field_56792_b = new HashMap();
    ...
    {
        if (!field_56792_b.containsKey(par1World))
        {
            field_56792_b.put(par1World, new ArrayList());
        }

        if (par5)
        {
            ((List)field_56792_b.get(par1World)).add(new RedstoneUpdateInfo(par2, par3, par4, par1World.getWorldTime()));
        }

        int i = 0;

        for (Iterator iterator = ((List)field_56792_b.get(par1World)).iterator(); iterator.hasNext();)
        {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        for (List list = (List)field_56792_b.get(par1World); list != null && !list.isEmpty() && par1World.getWorldTime() - ((RedstoneUpdateInfo)list.get(0)).updateTime > 60L; list.remove(0)) { }
    ...
    public void func_56768_a(World par1World, long par2, long par4)
    {
        List list = (List)field_56792_b.get(par1World);
