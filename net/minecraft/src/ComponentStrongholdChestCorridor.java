...
{
    private static final WeightedRandomChestContent field_55075_a[];
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 5, 3, 1, 1, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 5, 3, 1, 5, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 5, 3, 2, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 5, 3, 2, 4, par3StructureBoundingBox);

        for (int i = 2; i <= 4; i++)
        {
            placeBlockAtCurrentPosition(par1World, Block.field_55202_ak.blockID, 5, 2, 1, i, par3StructureBoundingBox);
        }
        ...
        if (!hasMadeChest)
        {
            ...
            {
                hasMadeChest = true;
                func_56600_a(par1World, par3StructureBoundingBox, par2Random, 3, 2, 3, field_55075_a, 2 + par2Random.nextInt(2));
            }
        }
    ...
    static
    {
        field_55075_a = (new WeightedRandomChestContent[]
                {
