...
public class SaveFormatOld implements ISaveFormat
{
    ...
    public List getSaveList()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            if (worldinfo != null)
            {
                arraylist.add(new SaveFormatComparator(s, "", worldinfo.getLastTimePlayed(), worldinfo.getSizeOnDisk(), worldinfo.func_56915_q(), false, worldinfo.isHardcoreModeEnabled(), worldinfo.func_55400_u()));
            }
        }
