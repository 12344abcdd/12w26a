...
public abstract class EntityLiving extends Entity
{
    ...
    {
        return worldObj.rayTraceBlocks(Vec3.func_58128_a().func_58134_a(posX, posY + (double)getEyeHeight(), posZ), Vec3.func_58128_a().func_58134_a(par1Entity.posX, par1Entity.posY + (double)par1Entity.getEyeHeight(), par1Entity.posZ)) == null;
    }
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        if (flag)
        {
            ...
            if (par1DamageSource != DamageSource.drown && par1DamageSource != DamageSource.field_58143_m)
            {
                setBeenAttacked();
            }
    ...
    public Vec3 getPosition(float par1)
    {
        if (par1 == 1.0F)
        {
            return Vec3.func_58128_a().func_58134_a(posX, posY, posZ);
        }
        else
        {
            ...
            return Vec3.func_58128_a().func_58134_a(d, d1, d2);
        }
    }
    ...
    public Vec3 getLook(float par1)
    {
        if (par1 == 1.0F)
        {
            ...
            return Vec3.func_58128_a().func_58134_a(f2 * f4, f6, f * f4);
        }
        else
        {
            ...
            return Vec3.func_58128_a().func_58134_a(f7 * f8, f9, f5 * f8);
        }
    }
