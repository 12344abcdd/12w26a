...
{
    private final boolean field_55210_a;
    ...
    public boolean shouldSideBeRendered(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        if (flag)
        {
            ...
            {
                return !func_55209_e(par1IBlockAccess.getBlockId(par2, par3, par4)) || (par1IBlockAccess.getBlockMetadata(par2, par3, par4) & 8) == 0;
            }
        }
    ...
    private static boolean func_55209_e(int par0)
    {
        return par0 == Block.field_55202_ak.blockID || par0 == Block.field_55205_bO.blockID;
    }

    public abstract String func_55208_c(int i);
}
