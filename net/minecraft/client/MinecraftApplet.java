...
public class MinecraftApplet extends Applet
{
    ...
    public void init()
    {
        ...
        mc.func_55069_a("true".equals(getParameter("demo")));
        ...
        if (getParameter("server-loc") != null)
        {
            mc.func_56443_w().func_57428_a(new File(getParameter("server-loc")));
        }

        if (getParameter("server-entry") != null)
        {
            mc.func_56443_w().func_57430_a(getParameter("server-entry"));
        }
